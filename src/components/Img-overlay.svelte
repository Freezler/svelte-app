...
<section
	class="select-none  items-center justify-center -translate-y-16 z-5 transparent relative w-full overflow-hidden bg-cover bg-no-repeat bg-[70%] h-[500px] bg-[url('https://source.unsplash.com/random/?svelte,macbook')]"
>
	<div class="relative top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed">
		<div class="flex h-full items-center justify-center">
			<div class="bg-black bg-opacity-50 px-8 w-screen h-full text-center text-white">
				<h1
					class="tracking-tight drop-shadow-[1px_-2px_1px#EF7FFF] mt-[30%] sm:mt-[17%] md:mt-[17%] lg:mt-[10%] mb-16 text-5xl font-bold  md:text-6xl xl:text-8xl from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r bg-clip-text text-transparent"
				>
					Randy de Vries
				</h1>
				<p
				...
				<div class=" mt-8 sm:mt-20 xs:bg-yellow-200 sm:bg-red-200 md:bg-blue-200 lg:bg-green-400 xl:bg-fuchsia-500">
					<a
						on:click={sendEmail}
