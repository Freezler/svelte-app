	...
	theme: {
		extend: {
			animation: {
				...
				'fast-fade-in': 'fade-in 0.3s ease-in-out',
				'slow-fade-out': 'fade-out 2s ease-in-out',
				'fast-fade-out': 'fade-out 0.3 ease-in-out',
				'slow-slide-in': 'slide-in 5.3s ease-in-out',
				'fast-slide-in': 'slide-in 3s ease-in-out',
				'slow-slide-up': 'slide-up 3.3s cubic-bezier(0.215, 0.61, 0.355, 1)',
				'slow-slide-out': 'slide-out 4s ease-in-out',
				'fast-slide-out': 'slide-out 3s ease-in-out',
				'ani-translate-y': 'translate-y 5s ease-in-out',
				'fast-slide-up': 'slide-up 2.6s cubic-bezier(0.215, 0.61, 0.355, 1)',
				'slow-slide-down': 'slide-down 3.6s cubic-bezier(0.215, 0.61, 0.355, 1)',
