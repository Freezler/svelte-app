	...
	theme: {
		extend: {
			...
			animation: {
				...
				'slow-fade-in': 'fade-in 0.9s ease-in-out',
				'fast-fade-in': 'fade-in 0.5s ease-in-out',
				'slow-fade-out': 'fade-out 0.5s ease-in-out',
				'fast-fade-out': 'fade-out 0.7s ease-in-out',
				'slow-slide-in': 'slide-in 0.9s ease-in-out',
				'slow-slide-in-rtl': 'slide-in-rtl 0.9s ease-in-out',
				'fast-slide-in': 'slide-in 3s ease-in-out',
				'slow-slide-up': 'slide-up 1.3s cubic-bezier(0.215, 0.61, 0.355, 1)',
				...
				'fast-slide-up': 'slide-up 1.3s cubic-bezier(0.215, 0.61, 0.355, 1)',
				'slow-slide-down': 'slide-down 1.2s cubic-bezier(0.415, 0.61, 0.355, 1)',
				'burger-smooth': 'burger-smooth 2s ease-in-out',
				'wave': 'wave .9s ease-in-out in',
			},
			keyframes: {
				'fade-in': {
					'0%': { opacity: '0' },
			...
			fontFamily: {
				...
				display: ['San Francisco', 'Oswald', 'sans-serif'],
				handwriting: ['Abril Fatface', 'Pacifico', 'cursive']
			},
			colors: {
				blueone: {
					50: '#e6f5ff',
