...
>
	...
	>
		...
		<button
			type="button"
			class="duration-900 flex h-[38px] w-[86px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center transition-all ease-in-out hover:scale-105 hover:bg-[var(--gradient-color)] hover:text-white"
			on:click={sendEmail}
