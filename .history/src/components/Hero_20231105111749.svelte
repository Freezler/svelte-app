...
<section class="animate-slow-fade-in mt-[30%] sm:mt-[0%] md:mt-[0%] lg:mt-[0%] xl:mt-[0px] w-full md:w-[60%] mx-auto flex h-[320px] flex-col items-center justify-around bg-slate-400 bg-opacity-30 bg-cover text-center">
