...
<div class="relative  flex-1 flex-row w-[100vw] h-[100vh] flex">
  ...
  <div class="slide relative transition-all duration-500 ease-in-out flex-1 flex-col h-[100%] w-[100%] overflow-hidden">
	<div class=" relative w-full h-full image transition-transform duration-500 ease-in-out transform hover:w-[100vw] hover:scale-125">
	  <img class="h-[100%] max-w-[100%] bg-center bg-slate-300"  src={item.image} alt={item.city} />
	</div>
	<div class="z-100 overlay relative w-[100vw] h-[100vh] flex flex-row hover:bg-rgba(0,0,0,0.5) -translate-y-[100%] bg-transparent opacity-0 transition-all duration-500 ease-in hover:opacity-100">
	  <div class="content transform duration-500 ease-in-out translate-x-[0] bg-yellow-400 opacity-100">
