...
>
	<div class="flex flex-col items-center gap-8">
		...
		<div
			class="z-100 box-content h-[120px] animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.8)]"
		>
			<h1 class="animate-slow-slide-in-ltr z-50 flex flex-col items-center justify-center">
				RANDY DE VRIES | WEB DEVELOPER | SVELTE
			</h1>
			<p
				class="typewriter m-0 flex w-[content] animate-slow-slide-in-rtl items-center justify-center bg-opacity-20 p-0
