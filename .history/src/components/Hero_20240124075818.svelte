...
>
	<div class="flex flex-col items-center j gap-4">
		...
		>
			...
			<p
				class="typewriter ml-8 flex w-[content] animate-slow-slide-in-rtl justify-start
			...
			<div class="z-45 flex h-[100px] w-[100%] flex-row items-center justify-center gap-4">
				<button
