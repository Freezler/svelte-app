			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				...
				>
					...
					>
						...
						<!-- Emblem Container -->
						<div
							class="emblem relative z-150 w-[content] :hover:opacity-0  items-center justify-center "
						>
							<svg class="w-[100px] object-contain py-8" viewBox="0 0 100 100">
								<image xlink:href={item.emblem} width="100" height="100" />
							</svg>
						</div>
						<!-- City information Container -->
						<ul
							class="city-info opacity-1 z-100 m-8 flex transform flex-col gap-4 0  px-2 py-4 font-display transition duration-[300ms] ease-in-out"
						>
