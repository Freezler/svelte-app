...
<style>
	* {
	...
	.content {
    transition: transform 600ms cubic-bezier(0.445, 0.05, 0.55, 0.95), width 600ms cubic-bezier(0.445, 0.05, 0.55, 0.95), opacity 600ms cubic-bezier(0.445, 0.05, 0.55, 0.95);
