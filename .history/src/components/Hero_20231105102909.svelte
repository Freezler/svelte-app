...
<section class="mt-[10%] sm:mt-[10%] md:mt-[25%] lg:mt-[20%] xl:mt-[0px] w-full md:w-[60%] mx-auto flex h-[300px] flex-col items-center justify-center bg-slate-400 bg-opacity-30 bg-cover text-center" id="home">
