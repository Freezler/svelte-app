...
{#if show}
	<div
		id="container"
		class="relative flex h-[100%] w-[100%] overflow-hidden bg-transparent transition:fade={{ delay: 250, duration:500 }}
		"
	>
		{#each info as item}
			<!-- Slide Container -->
			...
			>
				...
				>
					...
					>
						<!-- Content Container -->
						<div
							class="content z-100 flex flex-1 transform flex-col items-center justify-center text-center font-display text-white  shadow-2xl drop-shadow-2xl transition duration-[1900ms] ease-in-out text-shadow-[3px_3px_5px_hsla(230,45%,10%,0.9)] "
						>
							<h1
								class="title font-sans text-[clamp(1.2rem,5vw,4rem)] font-[800] text-white opacity-1 -translate-x-12
							"
