<div class="relative">
	...
	>
		...
		></svg
	>
	<div class="z-60 bg-opaque p-4 text-red-500 [&>p]:text-center [&>p]:text-xl [&>p]:mx-12 [&>p]:bg-gradient-to-tr from-red-900 via-rose-900 to-astral-900 relative rounded-lg text-center shadow-lg">
