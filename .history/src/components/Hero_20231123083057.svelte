...
>
	<div class="h-[clamp(220px, 20vw, 250px] w-[100%] flex-col">
		<div
			class="m-0 flex max-h-[100svh] w-[100%] md:-translate-y-10 animate-slow-fade-in items-center justify-center md:h-[1005] md:translate-y-10 lg:translate-y-[52px]"
		>
			<Avatar
		...
		<div class="flex flex-col">
			<div
				class="z-100 flex h-[320px] w-[100%] animate-slow-fade-in flex-row
				items-center justify-end bg-[oklch(12.5%_0.057_322.41)] bg-astral-950 bg-opacity-60 drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)] sm:flex-col lg:h-[320px]"
			>
				<h3
					class=" 
