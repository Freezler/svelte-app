...
<div class="z-400 flex w-[100%]  h-[content] flex-col justify-center items-center ">
	...
	/>
		...
		<div
		class=" z-100 h-[300px] w-[100%] animate-slow-slide-down flex-col items-center justify-cstart bg-astral-900 bg-opacity-50 text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
	>
		<p
