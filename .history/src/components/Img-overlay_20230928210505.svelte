		...
		<div class="flex h-full items-center">
			<div class="bg-secondary-900 bg-opacity-50 px-8 w-screen h-full text-center">
				<div class="flex flex-col items-center w-full">
					...
					>
						<span class="text-shadow-[-3px_-3px_1px_purple]">R</span>
						<span class="text-shadow-[-3px_-3px_1px_purple]">A</span>
						<span class="text-shadow-[-2px_-2px_1px_purple]">N</span>
						<span class="text-shadow-[-2px_-1px_1px_purple]">D</span>
						<span class="text-shadow-[1px_1px_2px_1px_purple]">Y</span>
					</h1>
					<HeroButton />
				</div>
			</div>
