...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide absolute flex h-[100vh] w-[100vw] items-center justify-center  overflow-hidden transition-all duration-[1400ms] hover:w-[1800px]"
		>
			<!-- image Container -->

			<div class=" image h-[100vh] hover:w-[100vw] flex flex-col  transform overflow-hidden ">
				<img
					src={item.image}
					class=" h-[100vh]   w-[800px] transition-all duration-[2400ms] "
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
