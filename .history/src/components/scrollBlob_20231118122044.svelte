...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide relative grid h-[100%] w-[100vw] transform grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden active:scale-100 transition-all  duration-[2000ms] ease-in-out hover:w-[1500%] "
		>
			<!-- image Container -->

			<div  class="bg-[url(${item.image} image h-[100vh] w-[100vw]  transform overflow-hidden">
				<!-- <img
					src={item.image}
				...
				>
					...
					>
						...
						<ul
							class="city-info opacity-1 z-100 m-8 flex  flex-col gap-8  px-2 py-4 font-display transition-all duration-[3000ms] ease-in-out"
						>
