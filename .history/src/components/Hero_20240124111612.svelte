...
>
	<div class="flex flex-col items-center gap-8">
		...
		>
			...
			>
				<button
					class="z-500 flex transform select-none items-center justify-center rounded-lg border border-bluethree-100 bg-bluetwo-950/40 px-5 py-2.5 text-center uppercase shadow transition-all duration-200 ease-in-out hover:scale-[1.015] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgba(0,255,255,0.1),rgba(0,0,5,0.5))] hover:text-white hover:drop-shadow-[0px_0px_2px_hsla(5,10%,9%,0.9)] active:scale-[0.999]"
					on:click={() => {
