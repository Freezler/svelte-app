...
<section
	...
	class=" z-100 overflow-none mt-32 flex h-[100svh] animate-slow-fade-in items-center justify-center overflow-hidden xt-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)] file:w-full"
>
	<div
