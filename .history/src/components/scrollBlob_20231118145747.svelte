...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide cubic-bezier(0.075, 0.82, 0.165, 1) flex h-[100vh] w-[100vw] items-center place-content-center justify-items-center overflow-hidden transition-all duration-[1400ms] hover:z-10"
		>
			<!-- image Container -->
