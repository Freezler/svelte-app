...
<nav
	class=" fixed bottom-0 z-10 flex w-[100%] select-none items-center justify-between text-center antialiased md:right-0 md:top-0 md:justify-center"
>
	<svg
	...
	<div
		class={`absolute top-0 z-50	hidden font-display flex-row-reverse  select-none items-center justify-center gap-8 bg-astral-950/40 bg-cover bg-center px-5 py-5 text-xl  uppercase text-blueone-50 md:flex ${
