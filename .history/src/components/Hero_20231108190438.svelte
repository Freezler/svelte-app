<script>
  ...
  <section class="animate-slow-fade-in grid align-top place-items-center w-full md:w-[60%] mx-auto h-[240px] bg-slate-400 bg-opacity-30 bg-contain bg-no-repeat text-center">
