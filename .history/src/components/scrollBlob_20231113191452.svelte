...
<div class="relative flex-row w-[100vw] h-[100vh] flex">
  ...
  <div class="slide relative transition-all duration-500 ease-in-out flex-1 flex-col h-[100vh]">
	...
	<div class="hover:overlay relative w-full h-full flex items-center justify-center bg-transparent opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100">
