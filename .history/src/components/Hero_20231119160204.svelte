	...
	<div class="  flex h-[100%] w-[100%] flex-col items-center justify-center gap-12  text-center">
		...
		>
			...
			<div class="flex flex-row gap-5">
				...
				<button  class="button-64 active:scale-[0.98]" on:click={() => window.location.reload()}><span class="text">new image</span></button
				>
...
<style>
	...
	.button-64 {
		...
		border: 0px;
		border-radius: 8px;
		box-shadow:  0px 0px 8px 0px hsla(296, 93%, 51%, 0.5);
	...
	.button-64 span {
		background-color: rgba(66, 46, 66, 0.6);
		padding: 16px 24px;
		border-radius: 6px;
		width: 100%;
		height: 100%;
	...
	.button-64:hover span {
		background: linear-gradient(135deg, #33d5f979, #48034b 50%, #33d5f979);
