<script>
	...
	import { easing, fade, fly, slide } from 'svelte/transition';
...
{#if show}
	<div
		...
		transition:fade={{ delay: 250, duration: 300, easing: 'cubic-bezier(0.075, 0.82, 0.165, 1)' }}
	>
		{#each info as item}
			<!-- Slide Container -->
			<div
			...
			>
				...
				>
					<img
						src={item.image}
						class=" cubic-bezier(1.375, 0.482, 0.765, 1) h-[100vh] w-[100%] transform  object-cover transition duration-[4200ms] "
						alt=""
						loading="lazy"
					/>
					<!-- Overlay Container -->
					...
					>
						<!-- Content Container -->
						<div
							class="content z-100 flex flex-1 transform flex-col items-center justify-center text-center font-display text-white  shadow-xl transition duration-[900ms] ease-in-out text-shadow-[3px_3px_5px_hsla(180,45%,10%,0.9)] "
						>
							<h1
