		...
		<div class="flex h-full items-center">
			<div class="bg-secondary-900 bg-opacity-50 px-8 w-screen h-full text-center">
				<div class="flex flex-col items-center w-full">
					<h1
						class="tracking-tighter w-[100%] mt-2 font-sans font-semithin -skew-y-2 -space-x-4 md:transform-none absolute text-tertiary-500 text-[clamp(5rem,8vw,4rem)] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[9rem]"
					>
