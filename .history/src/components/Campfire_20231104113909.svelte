...
<main class="flex justify-start items-center mx-auto  min-h-screen w-screen animate-slow-fade-in flex-col sm:justify-center gap-2 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
  <div class="flex flex-col items-center sm:justify-start justify-center gap-2 w-full">
	...
	<div class="img-shadow-[2px_2px_12px_[rgba(22,22,22,0.7] text-center drop-shadow-[2px_2px_12px_hsla(234,100%,59%,0.9)]] avatar-image flex h-[400px]  w-[60%] min-w-[80%] max-w-[60%] flex-col rounded-[8px] border-[1px] border-bluetwo-600 bg-cover bg-center drop-shadow-[2px_2px_12px_hsla(255,100%,59%,0.9)]">
	  ...
	  <button on:click={reloadAvatar} class=" w-60px shadow-[3px_3px_5px_rgba(22,22,22,0.7)] rounded-[8px] border-2 border-purpleone-700 bg-purpleone-300 bg-opacity-60 py-2 px-3 text-center text-rosetwo-200 opacity-80 drop-shadow-[3px_3px_5px_rgba(22,22,22,0.7)]">
		CLICK
	  </button>
	</div>
	{/if}
