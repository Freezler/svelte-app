...
>
	...
	>
		<button
			class="flex h-[44px] w-[120px] transform items-center active:sc justify-center rounded-[12px] bg-blue-900/30 text-center uppercase shadow transition-all duration-300 ease-in-out hover:scale-[1.045] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgba(0,255,255),0.7,rgba(0,0,255),0.7)] hover:text-white"
			on:click={() => {
