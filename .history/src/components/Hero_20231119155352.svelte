...
>
	<div class="  flex h-[100%] w-[100%] flex-col items-center justify-center gap-12  text-center">
		<Avatar
		class="mb-[40px] drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.6)]"
...
<style>
	...
	.button-64 span {
		background-color: rgba(66, 46, 66, 0.4);
		padding: 16px 24px;
		border-radius: 6px;
		width: 100%;
		height: 100%;
	...
	.button-64:hover span {
		background: linear-gradient(35deg, #af40ff, #5b42f3);
		transition: transform 4000ms cubic-bezier(0.25, 0.46, 0.45, 0.94) reverse;
