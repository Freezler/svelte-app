...
>
	...
	>
		...
		<button
			type="button"
			class="flex uppercase h-[48px] w-[120px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center shadow duration-300 hover:scale-[1.045] hover:bg-blue-200 transition-all ease-in-out  hover:bg-[linear-gradient(45deg,rgb(0,255,255),rgb(0,0,255))] hover:text-white"
			on:click={sendEmail}
		>
			Contact
