...
<div class="relative  flex-1 flex-row w-[100vw] h-[100vh] flex">
  ...
  <div class="slide relative transition-all duration-500 ease-in-out flex-1 flex-col  overflow-hidden">
	...
	<div class="z-100  roverlay  w-[100vw] h-[100vh] flex flex-row items-center translate-y-[100%] bg-transparent opacity-1 transition-all duration-500 ease-in hover:opacity-0">
