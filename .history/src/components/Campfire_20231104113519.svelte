...
<main class="translate-y-24 flex justify-start items-center mx-auto  min-h-screen w-screen animate-slow-fade-in flex-col sm:justify-center gap-2 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
