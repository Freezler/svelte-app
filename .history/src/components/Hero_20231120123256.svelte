...
>
	<div class="flex-col h-[60%] w-[100%] ">
		...
		<div class="flex h-[100vh] w-[100%]  flex-col items-center justify-center">
			...
			<div
				class=" z-100 justify-center h-[calc(100vh-320px)] w-[100%] animate-slow-slide-down flex-col items-center justify-items-center  bg-astral-900 bg-opacity-50   text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
			>
				<p
			...
			<!-- buttons start here!! -->
			<div class="gap-2 flex z-400 flex-row bg-red-500 w-[100%] items-center justify-center ">
				<button class="  active:bg-slate-100 transition-color duration-300"  on:click={() => window.location.reload()}
					><span class="text">refresh</span></button
				>
				<!-- svelte-ignore a11y-unknown-role -->
				<button class="" role="sumbmit" on:click={() => sendEmail()}
