...
>
	<div class="flex flex-col items-center gap-2">
		...
		<div
			class=" z-100 h-[120px] w-[100vw] animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)] mx-auto"
		>
			...
			bg-opacity-20 font-display text-[clamp(8px,2vw,1.6rem)] font-[500] text-purpleone-100 text-shadow-[3px_3px_5px_rgba(2,3,2,0.8)]"
			>
