...
>
	...
	<!-- buttons start here!! -->
	<div class="z-400 flex gap-4  mt-4 flex-row w-[100%] items-center justify-center">
		<button class="flex items-center justify-center h-[30px] w-[80px] rounded-[12px] text-center bg-blue-400 duration-300 hover:bg-blue-200">
		  refresh
		</button>
	  
		<button type="button" class="flex items-center justify-center h-[30px] w-[80px] rounded-[8px] bg-blue-400 text-center" on:click={sendEmail} >
		  Contact
		</button>
	  </div>
</section>
