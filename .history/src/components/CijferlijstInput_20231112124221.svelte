...
<div class="p-4 min-w-[340px] text-center">
	...
	/>
	<textarea bind:value={fileContent} class="text-center text-white h-[2.4rem] focus:outline-none resize-none w-[100%] min-w-[content] bg-transparent border-[1px] select-none border-gray-300 rounded-b- p-2"></textarea>
