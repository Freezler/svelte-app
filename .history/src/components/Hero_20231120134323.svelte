...
>
	...
	>
		<button
			class="flex h-[38px] w-[86px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center shadow duration-300 hover:scale-[1.045] hover:bg-blue-200"
		>
			refresh
			<img src="https://img.icons8.com/ios/15/000000/reload.png" style="margin-left: 0.2rem; opacity: 0.6;  border-radius: 18%; filter: invert(0%); background: canvas;" alt="" />
		</button>
