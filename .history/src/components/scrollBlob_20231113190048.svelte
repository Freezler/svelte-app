...
<div id="container" class="relative flex-row  w-[100vw] h-[100vh] flex items-center">
  ...
  <div class="slide relative flex-1 h-[100vh] h-overflow-hidden">
	...
	<div class="overlay relative top-0 left-0 right-0 w-full h-full flex items-center justify-center bg-transparent opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100">
	  ...
	  <div class="emblem transform duration-500 ease-in-out -translate-x-[0] transition duration-200 ease-in-out scale-105 opacity-100 z-400 hover:scale-100 -translate-y-[100%]">
