...
<section
	class="z-100 overflow-none -translate-y-10 bg-[oklch(12.5%_0.057_322.41)]bg-opacity-40 flex h-[100svh] w-screen animate-slow-fade-in flex-col items-center justify-center overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
	<div class="h-[clamp(220px, 20vw, 250px] w-[100%] flex-col">
		...
		<div class="grid grid-rows-3">
			<div
				class="z-100  subgrid w-[100%] animate-slow-fade-in 
			...
			<div
				class=" z-100 h-[35%] w-[100%] animate-slow-slide-down flex-row items-center justify-center justify-items-end bg-astral-900 bg-opacity-50 text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
			>
				<p
