...
<section
	...
	class=" z-100 overflow-none flex h-[100svh]w-full animate-slow-fade-in items-center justify-center overflow-hidden border-[0.5px] border-teal-700 text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)] backdrop-blur-[2px]" 
>
	<div class="p-8 flex flex-col items-center gap-8 bg-[hsla(245,90%,5%,0.2)] backdrop-blur-[2px]">
