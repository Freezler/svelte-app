...
>
	{#each info as item}
		...
		>
			...
			<div class=" image h-[100vh] w-[100%] flex flex-col items-center justify-center transform overflow-hidden hover:w-1200px]">
				<img
					src={item.image}
					class=" h-[100vh] w-[100vw] hover:w-[scale-110] object-center transition duration-[1400ms] cubic-bezier(1.375, 0.482, 0.765, 1)"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
