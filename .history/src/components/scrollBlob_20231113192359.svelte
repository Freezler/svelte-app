...
<div class="absolute top-0 left-0 right-0 bottom-0 flex-1 flex-row w-[100vw] h-[100vh] flex">
  ...
  <div class="slide relative transition-all duration-500 ease-in-out flex-1 flex-col h-[100%]">
	...
	<div class=" overlay relative w-full h-full flex flex-row items-center justify-center bg-rgba(0,0,0,0.5) -translate-x-[0] bg-transparent opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100">
