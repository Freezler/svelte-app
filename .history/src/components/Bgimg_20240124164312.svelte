...
>
	<div class="justify-top flex w-[100vh] flex-col items-center border-b-[1px] bg-black">
		{#if isLoading}
			...
			>
				<p class="text-sm animate-[pulse_0.0095s_ease-in-out_infinite] font-type pt-8 text-purplethree-100 drop-shadow-[2px_2px_12px_hsla(155,100%,59%,0.7)]"><Loader />Loading</p>
			</div>
		{:else if avatarUrl !== ''}
			<div
