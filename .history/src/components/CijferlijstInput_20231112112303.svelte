...
<div class="p-4 min-w-[340px]">
  ...
  {#if isSuccess}
	<p class="text-green-500 mt-2 mx-auto">Van harte gefeliciteerd, je bent geslaagd! Gemiddelde Cijfer: {{ JSON.stringify(gemiddeldeCijfer) }} {{ gemiddeldeCijfer }}</p>
  {:else}
