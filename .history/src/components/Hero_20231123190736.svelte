...
<section
class=" z-100 overflow-none flex-col h-[100svh] w-screen animate-slow-fade-in  overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
<div class="flex w-[100%] md:flex-row-reverse flex-col justify-center items-center h-[500px] md:h-[350px] gap-4 md:gap-0">
	<Avatar
		size="clamp(120px, 20vh, 180px)"
		initials="RV"
		textColor="white"
		name="Randy de vries"
		src="https://source.unsplash.com/300x300/?bald
	"
		alt="Randy de vries"
	/>
	<div
			class=" flex m-auto w-[200px]  h-[380px] animate-slow-slide-up border-2 items-center  px-8 py-4 font-sans justify-center rounded-full bg-[oklch(12.5%_0.057_322.41)] bg-opacity-60 drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
		>
		
			
		</div>
		<div class="flex flex-col border-2 bg-red-500 w-[content] px-8 py-4 font-sans h-[content]} justify-center items-center">
			<div
			...
			>
				<h3
					class=" 
					font-mono animate-slow-slide-down bg-[url(https://source.unsplash.com/1920x1080/?computers)] bg-cover bg-clip-text bg-center bg-no-repeat text-center
			...
			>
				<p
					class="type font-displayjustify-items-evenly ml-8 flex w-[content] animate-slow-slide-in-rtl items-center justify-start
