...
>
    refresh
    <img src="src/assets/refresh.png" class="img hover-animation h-[16px] w-[16px]  items-center  transition-all  selected:animate-spin-fast " style="opacity: 0.9; filter: invert(0%); margin-left: 5px; height: 16px; width: 16px;" alt="" />
</button>
		...
		>
			Contact
			<img src="src/assets/email.png" style="margin-left:5px; height: 21px; width: 18px; filter: invert(0%);" class="hover-animation icon items-center  transition-all fly-out duration-[2000ms]active:animate-fast-slide-out" alt="" />
		</button>
	</div>
</section>
