...
<section class="absolute top-[25%] xxs:top-[28%] xs:top-[25%] sm:top-[37%] md:top-[30%] lg:top-[30%] xl:top-[25%] mx-auto w-[100%] md:w-[100%] filter contrast-400 z-100 -translate-y-[190px] sm:-translate-y-[190px] md:-translate-y-[220px]  flex flex-col justify-center items-center text-center h-full">
