...
>
	{#each info as item}
		...
		>
			...
			<div class=" image h-[100%] w-[800px] flex flex-col items-center justify-center transform overflow-hidden hover:w-[100%]">
				<img
					src={item.image}
					class=" h-[100vh] w-[100%] hover:w-[scale-110] transition duration-[1400ms] cubic-bezier(1.375, 0.482, 0.765, 1)"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
