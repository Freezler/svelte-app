...
>
	<div class="flex flex-col items-center gap-8">
		...
		>
			<h1 class="vertical-align animate-slow-slide-in-ltr flex flex-col">
				RANDY DE VRIES | WEB DEVELOPER | SVELTE
			</h1>
			<p
				class="flex w-[65ch] animate-slow-slide-in-rtl items-center justify-center bg-opacity-20
			text-center font-display text-[clamp(8px,2.4vw,1.3rem)] font-[500] text-purpleone-100 text-shadow-[3px_3px_5px_rgba(2,3,2,0.8)]"
			>
