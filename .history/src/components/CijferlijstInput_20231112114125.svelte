...
<div class="text-center text-white -translate-y-10"><h3>voer een .txt of word bestand in om te checken.
	zorg dat het een cijferlijst is met de cijfers gescheiden door een komma. [1,2,3,4,5,6,7,8,9]
</h3></div>
