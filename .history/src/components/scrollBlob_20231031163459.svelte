<div class="relative">
	...
	>
		...
		></svg
	>
	<div class="z-60 bg-opaque p-4 text-red-500 relative rounded-lg text-center shadow-lg">
		<h1 class="mb-4 text-2xl font-semibold">Het Verhaal van Stingy Jack en de Lantaarn</h1>
		<p class="mb-4 rounded-lg border border-gray-300 bg-gray-200 bg-opacity-25 p-4 text-left text-gray-700">
