...
<main class="flex justify-center items-center mx-auto min-h-screen w-screen animate-slow-fade-in flex-col  md:mt-0 lg:mt-0 md:justify-center gap-2 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
  <div class="flex flex-col items-center sm:justify-center md:justify-center gap-2 w-full">
	...
	<div class="img-shadow-[2px_2px_12px_[rgba(22,22,22,0.7] text-center drop-shadow-[2px_2px_12px_hsla(234,100%,59%,0.9)]] avatar-image flex h-[300px]  w-[60%] min-w-[80%] max-w-[60%] flex-col rounded-[4px] border-[1px] border-bluetwo-600 bg-cover bg-center drop-shadow-[2px_2px_12px_hsla(255,100%,59%,0.9)]">
	  ...
	  <p class="text-shadow-[3px_3px_5px_rgba(22,22,22,0.9)] drop text-purpleone-100 text-sm text-center grid place-items-center h-full w-[100%] px-[10%]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente quaerat dolore rem obcaecati omnis deserunt.</p>
