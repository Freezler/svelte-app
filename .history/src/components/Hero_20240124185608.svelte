...
>
	...
	>
		...
		box-border h-[120px] py-8  px-8 animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(5,0%,19%,0.6)]  bg-[hsla(178,94%,63%,1)]"
		>
