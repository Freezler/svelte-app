...
<nav
	class="fixed bottom-0 rigth-0 left-0 z-10 flex w-[100%] select-none items-center justify-around text-center antialiased md:bottom-2 md:right-0 md:top-0 md:justify-center md:absolute"
>
	<svg
	...
	<div
		class={`absolute top-0 z-50	hidden select-none flex-row  items-center  border-b-rounded justify-center gap-8 bg-astral-950/70 bg-cover bg-center px-8 py-3 font-display text-xl  uppercase text-blueone-50 md:flex ${
