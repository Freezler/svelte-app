<div class="relative">
	...
	<script>
	  ...
	  <style>
		.container {
		  @apply p-4 max-w-md mx-auto my-8 bg-white rounded shadow-md;
		}
	  ...
	  <div class="container">
		...
		{#if showStory}
		  <p class="story">
			Lang geleden, in Ierland, leefde er een man genaamd Stingy Jack. Jack stond bekend om zijn hebzucht en gierigheid. Op een dag ontmoette hij de duivel bij een lokale herberg.		  </p>
