	...
	>
		<div>
			...
			>
				...
				/>
				<h3
					class="font-display text-[clamp(10px,10vw,8rem)] leading-[36px] font-[900] text-blueone-200 text-shadow-[3px_3px_5px_rgba(222,22,2,0.4)]"
				>
					<span
						class=" mr-[100%] translate-y-12 font-serif text-[clamp(16px,5vw,6rem)] font-[100] text-redone-100 text-shadow-[3px_3px_5px_rgba(242,12,55,0.4)]"
						>hi, I'm<br />
					</span>RANDY
				</h3>
			</div>
