...
<section class="mt-[10%] sm:mt-[5%] md:mt-[10%] lg:mt-[3%] xl:mt-[0px] w-full md:w-[60%] mx-auto flex h-[320px] flex-col items-center justify-center bg-slate-400 bg-opacity-30 bg-cover text-center" id="home">
