...
<main class="flex justify-center items-center mx-auto min-h-screen w-screen animate-slow-fade-in flex-col  md:mt-0 lg:mt-0 md:justify-a gap-2 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
