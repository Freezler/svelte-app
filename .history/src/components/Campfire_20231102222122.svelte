...
>
	...
	<p class="text-purpleone-100 text-md grid place-items-center h-full w-[100%] mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente quaerat dolore rem obcaecati omnis deserunt.</p></div>
	{/if}
