...
>
	...
	>
		...
		h-[120px] animate-slow-slide-down flex-row items-center justify-center rounded-lg border-[hsla(178,94%,63%,0.9)] bg-[hsla(180,8%,17%,0.6)] bachpx-8 py-4 pb-32 text-center drop-shadow-[2px_2px_12px_hsla(225,70%,49%,0.3)] xl:pb-36"
		>
			<h1
