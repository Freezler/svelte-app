<script>
  ...
  <div class=" w-full overflow-scroll animate-fast-slide-up flex flex-col items-center">
    <div class=" md:pt-28 gap-14 grid md:-translate-y-[50px] grid-cols-1 min-w-[100%] md:min-w-max max-w-[100%] sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3  h-[490px] overflow-scroll w-[70%] mx-auto">
