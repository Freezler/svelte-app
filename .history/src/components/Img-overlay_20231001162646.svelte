		...
		<div class="flex h-screen items-center">
			<div class=" flex h-full w-screen gap-8">
				...
				>
					...
					>
					<div class="flex flex-col items-center border-2 text-center jusvertical-align rounded border-white bg-white/10 backdrop-blur-sm bg-cover bg-center bg-no-repeat  w-56">
					<p
