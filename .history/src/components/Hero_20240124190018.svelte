...
>
	...
	>
		...
		animate-slow-slide-down flex-row rounded-lg items-center justify-center bg-[hsla(180,8%,17%,0.5)] px-8 py-4 pb-32  text-center drop-shadow-[2px_2px_12px_hsla(5,50%,59%,0.5)]"
		>
