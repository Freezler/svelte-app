...
<section
	...
	class=" z-100 overflow-none mt-32 flex h-[100svh] animate-slow-fade-in items-center justify-center overflow-hidden border-[0.5px] border-teal-700 text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)] file:w-full"
>
	<div
		class="flex flex-col items-center gap-8 rounded-md border border-gray-100 bg-blue-800 bg-opacity-10 bg-clip-padding p-8 backdrop-blur-sm backdrop-filter-blur-sm shadow-[3px_3px_15px_3px_rgba(22,22,22,0.7)]
	"
	>
		<div
