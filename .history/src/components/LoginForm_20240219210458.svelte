	...
	<div class="wrapper">
		...
		<form name="signup">
			...
			<div class=" border-2 border-slate-900 p-0">
				<label for="agree"><input type="checkbox" id="agree" name="agree" required /><small id="agree"
						>I agree to the terms and conditions</small></label
				>
			</div>
			<hr />
...
<style>
	...
	input:not([name='agree']:valid) + small {
		color: #62be74;
		font-size: 12px;
	}
