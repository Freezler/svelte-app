...
>
	<div
		class="  md:scale-90 flex h-screen w-[100%] -translate-y-[50px] scale-100 flex-col items-center justify-center gap-4 text-center xs:scale-105 sm:scale-100 xxl:scale-100"
	>
		<Avatar
