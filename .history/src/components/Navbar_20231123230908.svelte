...
>
	...
	<div
		class={`absolute top-0 z-50	hidden font-[Spartan] select-none items-center justify-center gap-8 bg-astral-950/40 bg-cover bg-center px-5 py-5 text-xl leading-8 uppercase text-blueone-50 md:block${
