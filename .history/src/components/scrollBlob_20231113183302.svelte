<script>
  ...
  <style>
	...
	.slide {
	  ...
	  overflow: hidden;
	  cursor: pointer;
	  /* Add any additional slide styles here */
	}
  </style>
  
  <div id="container" class="relative flex items-center h-[100vh] w-[100vw]">
  {#each info as item}
	<div class="slide relative flex-1 h-full overflow-hidden cursor-pointer">
