...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide  grid h-[100vh] w-[100vw]  grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden  transition-all duration-[1900ms] cubic-bezier(0.075, 0.82, 0.165, 1) hover:w-[1500%] "
		>
			<!-- image Container -->
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				<img
					src={item.image}
					class="relative h-[100vh] w-[100vw] object-fit-contain hover:scale-125 transition-all duration-[6000ms] cubic-bezier(0.075, 0.82, 0.765, 1)"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
