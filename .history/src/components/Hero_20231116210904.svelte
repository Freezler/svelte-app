...
>
	...
	<button
		class="px-4 py-2 border-2 inline-block transform hover:scale-all duration-300 ease-in-out hover:bg-gradient-to-br from-transparent via-teal-900 to-transparent bg-no-repeat rounded-lg"
		style="background-size: 350% 100%; transition: 0.5s linear;"
