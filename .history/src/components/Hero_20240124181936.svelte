...
>
	...
	>
		...
		<div
			class="z-100 p-16 box-border h-[120px] animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(5,0%,9%,0.4)]  bg-[hsla(5,0%,9%,0.3)]"
		>
