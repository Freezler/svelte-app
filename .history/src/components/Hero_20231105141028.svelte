...
<section class="mb-[1%] pb-[0rem] animate-slow-fade-in absolute top-[]  w-full md:w-[50%] mx-auto flex h-[80%] flex-col items-center justify-center bg-slate-400 bg-opacity-30 bg-cover text-center">
