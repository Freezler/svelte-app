			...
			<div class="bg-secondary-900 bg-opacity-50 px-8 w-screen h-full text-center">
				<div class="flex flex-col items-center w-full">
					...
					<p class="text-lg md:text-xl lg:text-2xl mb-8">
						Welkom op mijn portfolio waarin ik mijn passie voor webontwikkeling met je deel. Hier vind je een verzameling van mijn projecten van het afgelopen jaar. Met behulp van krachtige frameworks zoals Svelte, SvelteKit en Tailwind CSS, streef ik naar efficiënte en aantrekkelijke weboplossingen. Neem gerust een kijkje en ontdek mijn creatieve benadering van het web.
					  </p>
					<HeroButton />
				</div>
			</div>
