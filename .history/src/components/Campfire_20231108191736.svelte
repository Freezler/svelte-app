...
<main class="flex justify-start items-center mx-auto  h-[screen] w-screen animate-slow-fade-in flex-col sm:justify-center gap-4 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
