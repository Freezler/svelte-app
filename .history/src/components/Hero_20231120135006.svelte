...
>
	...
	>
		<button
			class="flex uppercase h-[2px] w-[100px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center shadow duration-300 hover:scale-[1.045] hover:bg-blue-200"
		>
			refresh
