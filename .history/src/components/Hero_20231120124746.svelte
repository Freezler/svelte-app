...
>
	...
	<div class="z-400 mx-auto flex h-[100px] flex-row items-center justify-center">
		<button class="transition-color bg-blue-400 px-3 py-8 duration-300 active:bg-slate-100">
			<span class="text">refresh</span>
		</button>

		<button type="button" class="h-[30px] w-[80px] rounded-[8px] bg-blue-400 px-3 py-8" on:click={sendEmail} >
			<span class="justify-self-center">Contact</span>
		</button>
	</div>
</section>
