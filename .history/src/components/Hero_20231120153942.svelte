...
>
	...
	>
		...
		<button
			type="button"
			class="border-[1px] border-bluethree-100 flex h-[44px] w-[120px] transform items-center justify-center rounded-[12px] bg-bluethree-950 text-center uppercase shadow transition-all duration-300 ease-in-out hover:scale-[1.005] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgb(0,255,255),rgb(0,0,255))] hover:text-white"
			on:click={sendEmail}
		>
			Contact
			<img
