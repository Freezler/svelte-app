...
<div class="p-4 min-w-[340px]">
	...
	/>
	<textarea bind:value={fileContent} class="text-white h-[2rem] focus:outline-none resize-none w-full min-w-[fit-content] bg-transparent border-[1px] select-none border-gray-300 rounded p-2"></textarea>
  
	{#if isSuccess}
	  <h3 class="text-green-500 mt-2 mx-auto px-3 py-1">Van harte gefeliciteerd, je bent geslaagd! Gemiddelde Cijfer: {gemiddeldeCijfer}</h3>
	{:else}
