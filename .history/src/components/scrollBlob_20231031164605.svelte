<div class="relative">
	...
	>
		...
		></svg
	>
	<div class="absolute top-0 translate-y-[400px] z-60 bg-opaque p-4 text-red-900 [&>p]:text-center [&>p]:text-greyone-700  [&>p]:text-xl [&>p]:mx-12 [&>p]:bg-gradient-to-tr from-red-300 via-roseone-200 to-orange-300 rounded-lg text-center shadow-lg">
		<h1 class="mb-24 text-2xl font-semibold">Het Verhaal van Stingy Jack en de Lantaarn</h1>
		...
		<p class="mb-4 rounded-lg border border-gray-300 bg-gray-200 p-4 text-left text-gray-700">
			Je kunt de site bekijken op <a href="https://stingy-jack.vercel.app">https://stingy-jack.vercel.app</a>
