...
>
	...
	<button
		...
		class="mx-auto w-[100px] -trans rounded-[8px] border-2 border-purpleone-700 bg-purpleone-900 bg-opacity-40 p-3 text-rosetwo-200 opacity-80 drop-shadow-[3px_3px_5px_rgba(22,22,22,0.7)]"
		>Next..</button
	>
</main>
