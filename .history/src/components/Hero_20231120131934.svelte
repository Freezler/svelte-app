...
>
	...
	<!-- buttons start here!! -->
	<div
		class="z-400 xs:scale-120 mt-4 flex h-[100px] w-[100%] flex-row items-center justify-center gap-4 sm:scale-125 md:scale-110"
	>
		<button
			class="flex h-[38px] w-[86px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center shadow duration-300 hover:scale-[1.005] hover:bg-blue-200"
		>
			refresh
		</button>
