...
>
	<div class="flex w-[100%] flex-col justify-center items-center h-[500px] md:h-[500px] gap-16 md:gap-4">
		<div
			class=" flex m-auto w-[content]  h-[100%] animate-slow-fade-in  border-2 justify-center items-center mt-8  "
		>
			<Avatar
