...
>
	<div class="flex flex-col items-center gap-2">
		...
		<div
			class=" z-100 h-[120px] w-[100vw] animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)] md:h-[150px]"
		>
			<h1 class="vertical-align flex animate-slow-slide-in-ltr flex-col">
				RANDY DE VRIES
			</h1>
			<p
				class="ml-8 flex  animate-slow-slide-in-rtl w-[35ch] justify-start
