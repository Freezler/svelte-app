...
<body>
  <div class="wrapper">
    ...
    <form name="signup">
      <small>signup form according to the <a class="wes" href="https://html.spec.whatwg.org/dev/forms.html">whatwg
          standards</a>
      </small>
      <hr>
      ...
      <input type="email" id="email" name="email" placeholder="enter a valid email"
        pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{8,16}$" required>
      <label for="password">Password <small>(min 8, max 16 characters. 1 uppercase, 1 lowercase 1
          number)</small></label>
      <input type="password" id="password" name="password" placeholder="enter a password"
        pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,16}$" required>

        <label for="agree"><input type="checkbox" id="agree" name="agree" required></label><small id="agree">I agree to the terms and conditions</small>
