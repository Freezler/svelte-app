...
<div class="z-400 flex w-[100%]   flex-col justify-center items-center ">
	...
	>
		<p
			class="type font-display items-center justify-between ml-8 flex w-[content] animate-slow-slide-in-rtl items-center justify-start
