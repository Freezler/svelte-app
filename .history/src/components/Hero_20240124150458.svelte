...
>
	<div
		class="flex flex-col items-center gap-8 rounded-md border border-gray-100 bg-blue-800 bg-opacity-10 bg-clip-padding p-8 backdrop-blur-sm backdrop-filter-
	"
	>
		<div
