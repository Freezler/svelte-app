...
<div id="container" class="relative flex h-[100vh] w-[100vw] overflow-hidden">
	{#each info as item}
		<div
			class="slide hover-w-[1000px] flex h-[100vh] w-[100%] items-center justify-center overflow-hidden transition-all duration-[1400ms]"
		>
			<div class="image flex h-[100vh] transform flex-col overflow-hidden hover:w-[800px]">
				<img
					src={item.image}
					class="h-[100vh] transition-all duration-[2400ms] ease-in-out"
					alt=""
					loading="lazy"
				/>
				<div
					class="overlay absolute inset-0 flex h-[100vh] w-[100%] items-center justify-center"
				>
					<div
