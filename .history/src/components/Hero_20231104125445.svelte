...
<section class="mt-[20%] sm:mt-[30%] md:mt- w-full md:w-[60%] mx-auto flex h-[300px] flex-col items-center justify-center bg-slate-400 bg-opacity-30 bg-cover text-center" id="home">
