	...
	<div class="flex h-[100%] w-[100%] flex-col items-center justify-center  text-center">
		<div>
			...
			>
				...
				/>
				<h3
					class="font-S text-[clamp(28px,14vw,8rem)] font-[900] leading-[42px] xxs:leading-[48px] xs:leading-[56px] sm:leading-[72px] md:leading-[84px] lg:leading-[84px] text-purpleone-100 text-shadow-[3px_3px_5px_rgba(55,42,25,0.9)]"
				>
					<span
