...
<section class=" animate-slow-fade-in grid place-items-s space-y-0 w-full md:w-[50%] mx-auto  h-full bg-slate-400 bg-opacity-30 bg-contain bg-no-repeat text-center">
