...
<div class="relative  flex-1 flex-row w-[100vw] h-[100vh] flex">
  ...
  <div class="slide relative transition-all duration-500 ease-in-out flex-1 flex-col  overflow-hidden">
	...
	<div class="z-100  overlay  w-[100%] h-[100vh] flex flex-row hover:bg-rgba(0,0,0,0.5) -translate-y-[100%] bg-transparent opacity-0 transition-o duration-500 ease-in hover:opacity-100">
