...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide relative grid h-[100vh] w-[100vw]  grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden  transition-all duration-[1900ms] cubic-bezier(0.075, 0.82, 0.165, 1) hover:w-[1500%] "
		>
			<!-- image Container -->
