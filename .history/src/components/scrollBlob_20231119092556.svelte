			...
			>
				...
				>
					...
					>
						<!-- Content Container -->
						<div
							class="content z-100 flex flex-1 transform flex-col items-center justify-center text-center font-display text-white hover:w[ shadow-xl transition duration-[900ms] ease-in-out text-shadow-[3px_3px_5px_hsla(180,45%,10%,0.9)] "
						>
							<h1
