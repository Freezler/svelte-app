...
>
	...
	>
		...
		<div
			class="text-text-shadow-[3px_3px_5px_rgba(22,22,22,0.9)] grid translate-y-[20px] grid-cols-2 place-content-center justify-items-center gap-4 place-self-center font-[900] xs:translate-y-[30px] sm:translate-y-[10px]"
		>
			<button
