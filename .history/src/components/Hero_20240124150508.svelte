...
<section
	...
	class=" z-100 overflow-none flex h-[100svh] file:w-full animate-slow-fade-in items-center justify-center overflow-hidden border-[0.5px] border-teal-700 text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)] mt-32 " 
>
	<div class="p-8 flex flex-col items-center gap-8 bg-blue-800 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100
	">
		<div class="z-400 flex w-[100svw] animate-slow-slide-up flex-col items-center justify-center">
			<Avatar
				size="132px"
				initials="RV"
				textColor="white"
		...
		<div
			class="z-100 box-border h-[120px] animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(225,100%,99%,0.3)]"
		>
			<h1 class="animate-slow-slide-in-ltr z-50 flex flex-col items-center justify-center">
				Hi, my name is Randy!
			</h1>
			<p
				class=" m-0 flex w-[content] animate-slow-slide-in-rtl items-center justify-center bg-opacity-20 p-0
			...
			>
				<span class="typewriter">
					I'm a junior web developer from Amsterdam, Netherlands.
				</span>
			</p>
			<div
