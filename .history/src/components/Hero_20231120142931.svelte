...
>
	...
	>
		...
		>
			Contact
			<img src="src/assets/email.png" style="margin-left:5px; height: 21px; width: 100%; filter: invert(0%);" class="h-[16px] w-[16px]  items-center  transition-all 2000ms hover:animate-fast-slide-in" alt="" />
		</button>
	</div>
</section>
