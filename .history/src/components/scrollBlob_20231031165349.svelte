<div class="relative">
	...
	>
		...
		></svg
	>
	<div class="absolute top-0 translate-y-[280px] z-60  p-4 text-red-900 [&>p]:text-center [&>p]:font-handwriting  [&>p]:text-greyone-200  [&>p]:text-xl [&>p]:mx-12 [&>p]:bg-redone-300 [&>p]:bg-opacity-20 rounded-lg text-center shadow-lg">
