...
>
	...
	<p class="text-purpleone-100 text-xl grid place-items-center h-full">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente quaerat dolore rem obcaecati omnis deserunt.</p></div>
	{/if}
