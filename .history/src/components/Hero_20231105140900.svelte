...
<section class="mb-[1%] pb-[0rem] animate-slow-fade-in   w-full md:w-[50%] mx-auto flex h-[80%] flex-col items-center justify-center bg-slate-400 bg-opacity-30 bg-cover text-center">
  <div class="flex flex-col relative">
	<div class="animate-slow-fade-in flex flex-col items-center sm:justify-center justify-center  translate-x-1/2 ">
