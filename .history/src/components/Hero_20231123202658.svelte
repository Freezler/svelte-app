...
<div class="flex flex-col items-center justify-center">
	<div class="z-400 flex w-[100%] flex-col items-center  Avatar">
		<Avatar
			size="150"
			initials="RV"
			textColor="white"
	...
	<div
		class=" z-100 h-[100px] w-[100%] animate-slow-slide-down flex-col items-center bg-astral-900 bg-opacity-50 text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
	>
		<p
			class="type ml-8 flex w-[content] h-[content] animate-slow-slide-in-rtl bg-opacity-20
