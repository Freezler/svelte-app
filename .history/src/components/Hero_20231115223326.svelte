...
>
	...
	>
		...
		>
			<button
				class="hover:transition-duration-300 w-[100%] rounded-[4px] border-[1px] border-pur border-purpleone-200 px-2 py-2 text-[clamp(8px,3vw,16px)] text-purple-700 transition-colors duration-300 ease-in-out hover:bg-purpleone-400 hover:text-white hover:transition-colors md:px-6 md:py-2"
