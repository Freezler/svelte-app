...
<div class="z-60 wrapper max-w-50 mx-auto px-2 w-[300px]">
    <div class="accordion flex flex-col p-0 space-y-6">
            ...
            >
                <div class="accordion-trigger" aria-expanded={panel === expandedPanel}>
                    {#if panel === expandedPanel}
                        <div
                            class="accordion-icon bg-gray-700 w-[40px] aspect-h-1 rounded-full z-10 w-[40px] p-3 absolute top-1/2 transform -translate-y-1/2 hidden"
                        ></div>
                    {/if}
                    <div
