...
>
	...
	>
		...
		>
			Contact
			<img src="src/assets/email.png" style="margin-left:5px; height: 21px; width: 18px; filter: invert(0%);" class="h-[16px] w-[16px]  items-center  transition-all fly-out duration-[200]active:animate-fast-slide-out" alt="" />
		</button>
	</div>
</section>
