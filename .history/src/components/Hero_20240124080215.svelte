...
<section
	...
	class=" z-100 overflow-none h-full borde w-full animate-slow-fade-in flex-col items-center justify-center overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
