		...
		>
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				...
				>
					<!-- Content Container -->
					<div
						class="relative content flex flex-1 opacity-0  gap-16 flex-col items-center justify-around text-center font-display text-white  shadow-2xl	 transition-opacity duration-[1300] ease-in-out text-shadow-[3px_3px_5px_hsla(0,0%,0%,0.9)]"
					>
						<h1
