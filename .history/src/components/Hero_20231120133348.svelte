...
>
	...
	>
		...
		<button
  type="button"
  class="flex h-[38px] w-[86px] transition-all transform ease-in-out items-center justify-center rounded-[12px] bg-blue-400 text-center duration-900 hover:scale-105 hover:bg-[var(--gradient-color)] hover:text-white"
  on:click={sendEmail}
  style="--gradient-color: linear-gradient(45deg, rgb(0, 255, 255), rgb(0, 0, 255));"
>
  Contact
</button>
	</div>
