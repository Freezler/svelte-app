...
>
	<div class="justify-top flex w-[100vh] flex-col items-center border-b-[1px] bg-black">
		{#if isLoading}
			<div
				class="flex h-screen w-[100%] min-w-[100%] max-w-[100%] animate-pulse items-center justify-center bg-cover bg-center shadow-[3px_3px_15px_3px_rgba(22,22,22,0.7)] drop-shadow-[2px_2px_2px_hsla(155,100%,59%,0.8)] "drop-shadow-[2px_2px_12px_hsla(155,100%,59%,0.8)]"
			>
