...
<div
	...
	transition:fade={{ delay: 250, duration: 3000 }}
	
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide relative grid h-[100%] w-[100%]  grid-cols-1 grid-rows-1 place-content-center justify-items-middle overflow-hidden active:scale-125 transition-all  duration-[2000ms] ease-in-out hover:w-[1500%] "
		>
			<!-- image Container -->
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				...
				<!-- Overlay Container -->
				<div
					class="overlay absolute inset-0  translate-x-full mt-24 flex w-[100vw] h-[100vh] items-center justify-center"
				>
					<!-- Content Container -->
					<div
