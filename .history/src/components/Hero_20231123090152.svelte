...
>
	<div class="flex w-[100%] flex-col justify-center items-center h-[500px] md:h-[500px] gap-4 md:gap-4">
		<div
			class=" flex m-auto w-[content]  h-[100%] animate-slow-slide-up border-2 items-center"
		>
			<Avatar
				size="clamp(180px, 20vh, 280px)"
				initials="RV"
				textColor="white"
				name="Randy de vries"
		...
		<div class="flex flex-col h-[auto] w-screen">
			...
			>
				<p
					class="type font-displayjustify-items-evenly ml-8 flex w-[content] animate-slow-slide-in-rtl items-center justify-center
