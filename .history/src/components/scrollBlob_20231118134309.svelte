	...
	{#each info as item}
		...
		>
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				...
				<!-- Overlay Container -->
				<div
					class="overlay absolute inset-0  translate-x-[w-content]  translate-y-full  flex w-[100vw] h-[100vh] items-center justify-center"
				>
					<!-- Content Container -->
					<div
						class="relative content flex flex-1 opacity-0  gap-8 flex-row items-center justify-center text-left font-display text-white  shadow-2xl transition-all duration-[1900ms] ease-in-out text-shadow-[3px_3px_5px_hsla(0,0%,0%,0.9)]"
					>
						<h1
