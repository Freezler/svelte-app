...
>
	...
	>
		...
		<button
			type="button"
			class="flex h-[38px] w-[86px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center duration-300 hover:scale-105 hover:bg-gradient-to-tr hover:from-blue-400 hover:to-blue-200"
			on:click={sendEmail}
		>
			Contact
		</button>
