...
>
	<div class="h-[60%] w-[100%] flex-col">
		...
		<div class="flex h-[100vh] w-[100%] flex-col items-center justify-center">
			...
			<div
				class=" z-100 h-[5%] w-[100%] animate-slow-slide-down flex-col items-center justify-center justify-items-end bg-astral-900 bg-opacity-50 text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
			>
				<p
