		...
		<div class="flex h-screen items-center">
			<div class=" flex h-full w-screen gap-8">
				...
				>
					...
					>
					<div class="flex flex-col items-center border-2 text-center justify-center rounded border-white bg-white/10 backdrop-blur-sm bg-cover bg-center bg-no-repeat  mt-50% 
