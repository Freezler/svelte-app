<script>
  ...
  <div id="flex-1 flex-row" class="w-[100vw] h-[100%] items-center absolute top-0 left-0 right-0	overflow-hidden	 ">
  {#each info as item}
  <div class="slide transition-all relative flex-1 overflow-hidden">
	...
	<div class="overlay absolute top-0 left-0 right-0 bottom-0">
	  <div class="content">
		...
		<div class="emblem hover:translate-x-[190%]" style="background-image: url({item.emblem});"></div>
		<ul class="city-info">
