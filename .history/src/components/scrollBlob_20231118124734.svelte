	...
	{#each info as item}
		...
		>
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				...
				<!-- Overlay Container -->
				<div
					class="overlay absolute inset-1 flex w-[100vw]  items-center justify-center"
				>
					<!-- Content Container -->
					<div
						class="relative content flex flex-1 opacity-0  flex-col items-center justify-around text-center font-display text-white  shadow-2xl	 transition-opacity duration-[1300] ease-in-out text-shadow-[3px_3px_5px_hsla(0,0%,0%,0.9)]"
					>
						<h1
						...
						<ul
							class="city-info opacity-1 z-100 m-8 flex transform flex-col  px-2 active:-translate-x-1/2 font-display transition-all duration-[3000ms] ease-in-out"
						>
