...
>
	...
	>
		<button
			...
			on:click={() => (document.target.Avatar.src = 'https://source.unsplash.com/560x560/?human')}
		>
			refresh
			<img src="src/assets/refresh.png" style="; opacity: 0.9;   filter: invert(0%);margin-left:5px; height: 16px; width: 16px;" alt="" />
		</button>
