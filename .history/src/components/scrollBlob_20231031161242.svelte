<div class="relative">
	<div class="relative z-50 animate-slow-fade-in text-center">
		<h1
			class="absolute top-1/2 left-1/2 -translate-x-1/2 -	 translate-y-52 text-center font-display text-6xl font-semibold bg-[url(https://cdn.discordapp.com/emojis/965692558526640640.png?v=1)] bg-clip-text bg-no-repeat filter"
		>
			Jack o'Lantern
		</h1>
	</div>
