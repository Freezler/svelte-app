...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide cubic-bezier(0.075, 0.82, 0.165, 1) grid h-[100vh] w-[100vw] grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden transition-all duration-[1400ms] hover:w-[800px] "
		>
			<!-- image Container -->
