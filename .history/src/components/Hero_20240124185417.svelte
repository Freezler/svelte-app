...
>
	...
	>
		...
		box-border h-[120px] py-8  px-4animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(5,0%,9%,0.4)]  bg-[hsla(5,0%,9%,0.3)]"
		>
