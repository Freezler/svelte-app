...
<div id="container" class="w-screen h-full flex items-center">
  {#each info as item}
  <div class="slide relative flex-1 h-full overflow-hidden">
	<div class="image transition-transform duration-500 ease-in-out transform scale-100 hover:scale-120">
	...
	<div class="overlay absolute top-0 left-0 right-0 w-full h-full flex items-center justify-center bg-transparent opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100">
	  ...
	  <div class="emblem transform duration-500 ease-in-out scale-105 opacity-100 z-400 hover:translate-x-0">
