...
<section
	class=" z-100 overflow-none flex-col h-[100svh]justify-center it w-screen animate-slow-fade-in  overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
