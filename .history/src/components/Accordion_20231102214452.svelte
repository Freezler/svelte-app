...
<div class="z-60 wrapper max-w-50 mx-auto px-2 mt-[100px] w-[300px]">
            ...
            >
                <div class="accordion-trigger" aria-expanded={panel === expandedPanel}>
                    {#if panel === expandedPanel}
                        <div
                            class="accordion-icon bg-red rounded-full z-10 w-[40px] p-3 absolute top-[10%] transform -translate-y-1/2 background-att    "
                        ></div>
                    {/if}
                    <div
