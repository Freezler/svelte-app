...
>
	<div class="h-[60%] w-[100%] flex-col">
		...
		<div class="flex h-[100vh] w-[100%] flex-col items-center justify-center">
			...
			<!-- buttons start here!! -->
			<div class="z-400 flex  flex-row items-center justify-center gap-2 bg-red-500/30">
				<button
				...
				<button class="bg-blue-400 w-[200px] py-4 px-3" role="sumbmit" on:click={() => sendEmail()}
