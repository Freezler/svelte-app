...
>
	<div class="flex w-[100%] flex-col justify-center items-center h-[500px] md:h-[500px] gap-4 md:gap-4">
		<div
			class=" flex m-auto w-[content]  h-[100%] animate-slow-slide-up border-2 items-start justify-center rounded-full bg-[oklch(12.5%_0.057_322.41)] bg-opacity-60 drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
		>
		<p>RANDY</p>
			<Avatar
