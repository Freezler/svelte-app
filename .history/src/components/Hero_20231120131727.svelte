...
>
	...
	<!-- buttons start here!! -->
	<div class="z-400 mt-4 flex w-[100%] xs:scale-120 sm:scale-125 md:scale-110 h-[100px] flex-row items-center justify-center gap-4">
		<button class="h-[38px] w-[86px] rounded-[12px] text-center bg-blue-400 duration-300 hover:bg-blue-200 flex items-center justify-center shadow">
			refresh
		  </button>

		  <button
		  type="button"
		  class="flex h-[30px] w-[80px] items-center justify-center rounded-[16px] bg-blue-400 text-center duration-300 hover:bg-blue-500 transform hover:scale-105"
		  on:click={sendEmail}
		>
		  Contact
		</button>
