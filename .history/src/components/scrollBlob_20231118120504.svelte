		...
		>
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				...
				>
					<!-- Content Container -->
					<div
						class=" content flex flex-1 -translate-x-[30px] transform flex-col items-center justify-center text-center font-display text-white  hover:opacity-100 transition duration-[2300] ease-in-out text-shadow-[3px_3px_5px_hsla(0,0%,0%,0.4)]"
					>
						<h1
