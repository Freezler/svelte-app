...
{#if show}
	...
	>
		{#each info as item}
			<!-- Slide Container -->
			<div
				class="slide flex h-[100vh] w-[100%] hover:w-[3/4]  flex-col  items-center justify-center overflow-hidden transition-all duration-[700ms] cubic-bezier(0.075, 0.82, 0.165, 1)"
			>
				<!-- image Container -->
