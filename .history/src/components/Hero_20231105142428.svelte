...
<section class=" animate-slow-fade-in grid place-items-center  w-full md:w-[50%] mx-auto  h-[200px] bg-slate-400 bg-opacity-30 bg-cover text-center">
  <div class="flex flex-col relative gap-8">
	<div class="-translate-y-[50%] animate-slow-fade-in flex flex-col items-center  justify-start ">
	  <Avatar bgColor="hsla(234,100%,59%,0.3)" textColor="white" name="Randy de vries" src="https://avataaars.io/?avatarStyle=Circle&topType=NoHair&accessoriesType=Blank&facialHairType=Blank&clotheType=Hoodie&clotheColor=Blue03&eyeType=Default&eyebrowType=RaisedExcitedNatural&mouthType=Twinkle&skinColor=Pale" size="calc(20vh - 1000px)" />
	</div>
