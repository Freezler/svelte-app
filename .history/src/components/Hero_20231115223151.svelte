...
>
	...
	>
		...
		/>
		<div
			class=" flex flex-col items-center justify-items-center py-5 px-6  h-[screen] w-[max-content] grid-cols-1 place-content-center rounded-[8px] bg-[hsla(,0%,0%,0)] bg-opacity-50"
		>
