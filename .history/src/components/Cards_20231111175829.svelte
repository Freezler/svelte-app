<script>
  ...
  <div class="relative  justify-center mx-auto  h-[100%] w-full antialiased  text-center animate-slow-fade-in flex flex-col items-center justify-top">
    <div class="pt-8 md:pt-[28%] xl:pt-[25%] gap-16 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 overflow-visible w-[400px]  sm:w-[400px] md:w-[80%] lg:w-[80%] mx-auto">
