...
>
	{#each info as item}
		...
		>
			...
			<div class=" image h-[100vh] w-[100vw] flex flex-col items-center justify-center transform overflow-hidden hover:w-2200px]">
				<img
					src={item.image}
					class=" h-[100vh] w-[100vw] hover:w-[scale-120] object-fit transition duration-[1400ms] cubic-bezier(1.375, 0.482, 0.765, 1)"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
