...
>
	...
	>
		...
		<div
			class="z-80 border=[1px] md:pb-34 lg:pb-34 box-border
			
		h-[120px] animate-slow-slide-down flex-row items-center justify-center rounded-lg border-[hsla(178,94%,63%,0.9)] bg-[hsla(180,8%,17%,0.6)] backdrop-blur-[1px] px-8 py-4 pb-32 text-center drop-shadow-[2px_2px_12px_hsla(225,70%,49%,0.3)] xl:pb-36"
		>
			<h1
				class="animate-slow-slide-in-ltr z-50 flex flex-col items-center justify-center text-[clamp(1rem,5vw,1.4rem)]"
			>
				Hi, my name is Randy!
			</h1>
			<p
				class="  flex w-[100%] animate-slow-slide-in-rtl   bg-opacity-20
			 font-display text-[clamp(12px,2vw,1.6rem)] font-[500] text-purpleone-100 text-shadow-[3px_3px_5px_rgba(2,3,2,0.8)]"
			>
				<span class="typewriter"> Welcome to my Personal website, take a look around!</span>
			</p>
			<div
				class="z-45 flex h-[100px] w-[100%] scale-[0.8] flex-row items-center justify-center gap-4 pb-12 transition-all sm:scale-90 md:scale-95 lg:scale-100 xl:scale-110"
			>
				<button
				...
				<button
					type="button"
					class="z-45 active:schale-[0.999] flex transform select-none items-center justify-center rounded-lg bg-bluetwo-950/50 px-5 py-2.5 text-center uppercase shadow transition-all duration-200 ease-in-out hover:scale-[1.015] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgba(0,255,255,0.5),rgba(0,0,5,0.5))] hover:text-white hover:drop-shadow-[0px_0px_2px_hsla(5,10%,9%,0.9)]"
					on:click={sendEmail}
				>
					Contact
					<img
