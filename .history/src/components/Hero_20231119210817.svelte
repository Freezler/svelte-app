...
>
	<div class="flex h-[100%] w-[100%] flex-col items-center justify-center  text-center">
		<div>
			<div
				class="flex h-[screen] w-[100%] animate-slow-slide-down flex-row-reverse items-center gap-[40px] rounded-[8px] bg-[oklch(12.5%_0.057_322.41)] bg-astral-950 bg-opacity-40 px-6 pb-[40px]  text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
			>
				<Avatar
					size="clamp(250px, 35vw, 320px)"
					initials="RV"
				...
				/>
				<h3
					class="font-display text-[clamp(28px,14vw,6rem)] font-[900] leading-[42px] xxs:leading-[62px] sm:leading-[64px]"
				>
					<span
						class=" mr-[100%] font-antialiased text-[clamp(16px,5vw,5rem)] font-[100] text-redone-100 text-shadow-[3px_3px_5px_rgba(242,12,55,0.4)]"
						>hi, I'm<br />
					</span>RANDY
				</h3>
			</div>
