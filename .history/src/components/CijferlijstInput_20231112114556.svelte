...
<div class="p-4 min-w-[340px]">
  ...
  />
  <textarea bind:value={fileContent} class="text-white h-[2rem] focus:outline-none re w-full min-w-[fit-content] bg-transparent border-none select-none border-gray-300 rounded p-2"></textarea>
