...
>
	<div class="justify-top flex w-full flex-col items-center border-b-[1px]">
		...
		{:else if avatarUrl !== ''}
			<div
				class="mt-24   drop-shadow-[2px_2px_12px_hsla(134,50%,9%,0.9)]] avatar-image flex h-screen w-[100%] min-w-[100%] max-w-[100%] scale-100 flex-col items-center justify-center  bg-cover bg-center text-center md:scale-[1.1]"
			>
				<Hero />
				<Header />
			</div>
