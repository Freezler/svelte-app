...
<section class="mb-[1%] pb-[1rem] animate-slow-fade-in   w-full md:w-[50%] mx-auto flex h-full flex-col items-center justify-start bg-slate-400 bg-opacity-30 bg-cover text-center">
