	...
	<div class="flex w-[100%] flex-col justify-center items-center h-[100svh] gap-16">
		...
		<div class="flex flex-col h-[40svh] w-screen">
			...
			>
				<h3
					class=" 
					font-mono letter-spacing-[1px] animate-slow-slide-down bg-[url(https://source.unsplash.com/1920x1080/?computers)] bg-cover bg-clip-text bg-center bg-no-repeat text-center
