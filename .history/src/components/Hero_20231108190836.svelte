<script>
  ...
  <section class="animate-slow-fade-in flex justify-center items-center h-[140px] w-full md:w-[60%] mx-auto  bg-slate-400 bg-opacity-30 bg-cover bg-repeat text-center">
