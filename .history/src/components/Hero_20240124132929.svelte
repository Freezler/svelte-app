...
<section
	...
	class=" z-100 overflow-none flex h-[100svh]w-full animate-slow-fade-in items-center justify-center overflow-hidden border-[0.] border-teal-700 text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)] bg-" 
>
