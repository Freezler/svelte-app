...
<div class="flex w-[100%] flex-col justify-center items-center gap-4 md:gap-0">
	...
	/>
		...
		<div
		class=" z-100 h-[55%] w-[100%] animate-slow-slide-down flex-col items-center justify-center bg-astral-900 bg-opacity-50 text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
	>
		<p
