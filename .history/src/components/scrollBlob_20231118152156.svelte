...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide flex h-[100vh] w-[100%] items-center justify-center  overflow-hidden transition-all duration-[1400ms] hover-w-[1000px] "
		>
			<!-- image Container -->
			...
			<div class=" image h-[100vh] hover:w-[800px] flex flex-col  transform overflow-hidden ">
				<img
					src={item.image}
					class=" h-[100vh]   w-[800px] transition-all ease-in-out duration-[2400ms] "
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
