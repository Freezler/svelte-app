...
>
	<div class="justify-top flex w-[100vh] flex-col items-center border-b-[1px] bg-black">
		{#if isLoading}
			...
			>
				<p class="text-xl animate-[pulse_2s_ease_infinite] font-type pt-8 text-purplethree-600 drop-shadow-[2px_2px_12px_hsla(155,100%,159%,0.9)]"><Loader />Loading</p>
			</div>
		{:else if avatarUrl !== ''}
			<div
				class="  drop-shadow-[2px_2px_12px_hsla(54,50%,99%,0.5)]] avatar-image flex h-screen w-[1] min-w-[100%] max-w-[1440] scale-100 flex-col items-center justify-center  bg-cover bg-center text-center md:scale-[1.3]"
			>
				<Hero />
				<Header />
			</div>
