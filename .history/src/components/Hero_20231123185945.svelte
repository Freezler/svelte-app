...
>
	<div class="flex w-[100%] md:flex-row-reverse flex-col justify-center items-center h-[500px] md:h-[350px] gap-4 md:gap-0">
		<div
			class=" flex m-auto w-[200px]  h-[380px] animate-slow-slide-up border-2 items-center  px-8 py-4 font-sans justify-ce	rounded-full bg-[oklch(12.5%_0.057_322.41)] bg-opacity-60 drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
		>
