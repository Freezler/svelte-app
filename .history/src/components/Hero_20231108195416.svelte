<script>
  ...
  <section class=" -translate-y-[100px] animate-slow-fade-in flex justify-center items-center h-[100%] w-full md:w-[60%] mx-auto  bg-ga-400 bg-opacity-60 bg-cover bg-repeat text-center">
