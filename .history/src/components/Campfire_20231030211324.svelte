...
<main class="flex h-screen w-screen animate-slow-fade-in flex-col items-center justify-top pt-[] gap-8 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
	{#if isLoading}
