...
>
	...
	<!-- buttons start here!! -->
	<div class="z-400 mt-4 flex w-[100%] flex-row items-center justify-center gap-4">
		<button
		...
		<button
			type="button"
			class="flex h-[30px] w-[80px] items-center justify-center rounded-[16px] bg-blue-400 text-center duration-300 hover:bg-blue-200  hover:bg-blue-200"
			on:click={sendEmail}
		>
			Contact
		</button>
