...
<nav
	class=" min-w-[100%] fixed bottom-0 z-10 flex h-20 w-full select-none items-center justify-between bg-transparent px-0 focus:select-none md:top-0"
>
...
{#if showNav}
	<div
		class=" fixed inset-0 z-100 flex animate-fast-fade-in select-none items-center justify-center bg-gray-800 bg-opacity-75 backdrop-blur-[4px]"
		on:click={toggleNav}
