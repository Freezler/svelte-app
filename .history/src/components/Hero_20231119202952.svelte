...
>
	<div
		class="flex h-[100%] w-[100%] flex-col items-center justify-center gap-12 -space-x-[20px] text-center"
	>
		<div>
			<div
			...
			>
				...
				>
					<span
						class="font-serif text-[clamp(16px,5vw,6rem)] font-[100] text-redone-100 text-shadow-[3px_3px_5px_rgba(242,12,55,0.4)]"
						>hi, I'm<br />
					</span>RANDY
				</h3>
			</div>
