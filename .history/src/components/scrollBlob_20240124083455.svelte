...
<style>
	* {
	...
	.content {
    transition: transform 900ms cubic-bezier(0.445, 0.05, 0.55, 0.95), width 900ms cubic-bezier(0.445, 0.05, 0.55, 0.95), opacity 900ms cubic-bezier(0.445, 0.05, 0.55, 0.95);
