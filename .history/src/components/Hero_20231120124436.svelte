...
>
	...
	<div class="z-400 flex h-[100px] flex-row items-center justify-center mx-auto">
        <button class="transition-color duration-300 active:bg-slate-100 bg-blue-400 px-3 py-8">
            <span class="text">refresh</span>
        </button>

        <button class="h-[30px] w-[80px] bg-blue-400 px-3 py-8" role="submit">
