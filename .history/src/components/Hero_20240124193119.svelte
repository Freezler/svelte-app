...
>
	...
	>
		...
		animate-slow-slide-down flex-row rounded-lg items-center justify-center bg-[hsla(180,8%,17%,0.6)] px-8 py-4 pb-32 lg:pb-36  text-center drop-shadow-[2px_2px_12px_hsla(225,70%,49%,0.3)]"
		>
