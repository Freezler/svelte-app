...
>
	<div class="  flex h-[100%] w-[100%] flex-col items-center justify-center gap-12 text-center">
		...
		/>
			<h3 class="font-display text-[clamp(10px,10vw,8rem)] font-[900] text-blueone-200">
				<span class="font-serif text-[clamp(16px,5vw,6rem)] font-[100]text-shadow-[3px_3px_5px_rgba(222,22,22,0.9)] text-redone-300"
					>hi, I'm<br />
				</span>RANDY
			</h3>
		</div>
