...
<nav
	class="absolute top-0 left-0  z-10 flex w-[100%] select-none items-center justify-between text-center antialiased md:bottom-2 md:right-0 md:top-0 md:justify-center md:absolute"
>
	<svg
