<div class="relative">
	<div class="relative z-50 animate-slow-fade-in text-center backdrop-blur-[0.7px]">
		<h1
			class="drop-shadow-[3px 3px 3px rgba(22, 22, 22, 0.9)] translate-y-52 text-center font-display text-3xl font-bold text-gradient-to-br from-purpleone-900 via-bluetwo-300 to-rosetwo-900 bg-clip-text bg-no-repeat filter"
		>
			Jack o'Lantern
		</h1>
	</div>
