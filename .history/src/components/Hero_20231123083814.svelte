...
>
	<div class="flex w-[100%] flex-col">
		<div
			class="m-0 flex max-h-[100svh] w-[100%]  animate-slow-fade-in justify-center items-center md:h-[100%]"
		>
			<Avatar
		...
		<div class="flex flex-col h-[svh]">
			<div
				...
				items-center bg-[oklch(12.5%_0.057_322.41)] bg-astral-950 bg-opacity-60 drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)] sm:flex-col h-[5	20px]"
			>
				<h3
					class=" 
