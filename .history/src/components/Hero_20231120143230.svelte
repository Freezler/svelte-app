...
>
	...
	>
		...
		>
			Contact
			<img src="src/assets/email.png" style="margin-left:5px; height: 21px; width: 18px; filter: invert(0%);" class="h-[16px] w-[16px]  items-center  transition-all 2000ms hoveranimate-fast-slide-in" alt="" />
		</button>
	</div>
</section>
