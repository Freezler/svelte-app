		...
		>
			...
			<div class=" image h-[100vh] w-[100vw] transform overflow-hidden">
				...
				<div class="overlay h-[0] w-[100vw] inset-0 absolute flex flex-row ">
					<!-- Content Container -->
					<div
						class="content opacity-0  flex flex-1 flex-col items-center justify-around text-left font-display text-white shadow-2xl transition-all	tran duration-900 ease-in-out text-shadow-[3px_3px_5px_hsla(0,0%,0%,0.9)]"
					>
						<h1
