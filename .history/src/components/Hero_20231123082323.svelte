	...
	<div class="h-[clamp(220px, 20vw, 250px] w-[100%] flex-col">
		...
		<div class="flex flex-col">
			...
			>
				...
				>
					<span
						class="box-border flex h-[100svh] w-[90px] translate-x-4 items-center place-self-center font-display text-[clamp(8px,4vw,2rem)] font-[100] text-blueone-300 text-shadow-[1px_1px_5px_rgba(25,292,445,0.9)]"
						>hi, I'm<br />
					</span>RANDY
				</h3>
			</div>
