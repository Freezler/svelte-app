...
<section class=" animate-slow-fade-in grid  align-middle place-items-center w-full md:w-[60%] mx-auto  h-full bg-slate-400 bg-opacity-30 bg-contain bg-no-repeat text-center">
  <div class="flex flex-col relative gap-8">
	<div class="-translate-y-[10%] animate-slow-fade-in flex flex-col items-center  justify-start ">
	...
	<div class="font-[500] ">
	  ...
	  <button class="text-[12px] bg-purpleone-200 py-1 px-2 rounded-md mb-16 hover:text-white hover:bg-black" on:click={handleContactButtonClick} type="button">
		CONTACT
	  </button>
	</div>
  </div>
