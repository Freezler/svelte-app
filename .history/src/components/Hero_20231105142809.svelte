...
<section class=" animate-slow-fade-in grid place-items-center -space-y-4 w-full md:w-[50%] mx-auto  h-full bg-slate-400 bg-opacity-30 bg-contain bg-no-repeat text-center">
