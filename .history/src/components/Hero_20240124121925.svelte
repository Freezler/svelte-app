...
<section
	...
	class=" z-100 overflow-none flex h-full w-full animate-slow-fade-in items-center justify-center overflow-hidden border-4 border-teal-700 text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]" blu
>
