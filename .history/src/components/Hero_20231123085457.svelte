...
>
	<div class="flex w-[100%] flex-col justify-center items-center h-[100svh] gap-16">
		<div
			class=" flex m-auto w-[100%]  animate-slow-fade-in justify-center items-between bg-[url(https://source.unsplash.com/1920x1080/?computers)] bg-cover bg-clip-text bg-center bg-no-repeat"
		>
			<Avatar
				size="clamp(140px, 25vh, 280px)"
				initials="RV"
				textColor="white"
				name="Randy de vries"
