...
>
	<div class="flex-col h-[60%] w-[100%] ">
		...
		<div class="flex h-[100vh] w-[100%]  flex-col items-center justify-center">
			...
			<div
				class="z-100 justify-content h-[max-content] animate-slow-slide-down flex-col items-center justify-items-center rounded-[8px] bg-astral-900 bg-opacity-20 px-6 pb-[60px] pt-4 text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
			>
				<p
