<script>
  ...
  <main class="flex h-screen w-screen animate-slow-fade-in flex-col items-center justify-center bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
	...
	<button on:click={() => window.location.reload()} class="mt-8 rounded-md border-2 border-purpleone-700 bg-purpleone-500 p-3 text-rosetwo-400 opacity-80 shadow-sm shadow-purpleone-500">Refresh Avatar</button>
  </main>
