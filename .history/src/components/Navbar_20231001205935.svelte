...
>
	...
	<button class="mr-4 select-none text-white focus:select-none lg:hidden" on:click={toggleNav}>
	...
	<div
		class={`font-custom text-semibold mr-8 mt-0 hidden select-none items-center justify-center gap-8 font-sans lg:flex ${
