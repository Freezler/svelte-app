...
<div id="container" class="w-[100vw] h-[100vh] flex overflow-hidden" data-sveltekit-prefetch data-sveltekit-noscroll data-sveltekit-preload-data>
  {#each info as item}
	<div class="relative flex-1 h-[100vh] overflow-hidden slide transform scale-125">
	  <div class="image transform-all h-[100vh] overflow-hidden hover:scale-125 transition-transform duration-500 ease-in-out" style="background-image: url({item.image});"></div>
