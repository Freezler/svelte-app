...
<nav
	class=" fixed bottom-0 z-10 flex h-20 w-full select-none items-center justify-between bg-transparent px-0 focus:select-none md:top-0"
>
	...
	<button class="mr-4 select-none text-white focus:select-none active:select-none md:lg:hidden" on:click={toggleNav}>
	...
	>
		...
		>
			<a href="/" tabindex="0" class="text-cyan-200"
				...
				<hr class="w-full border-bluetwo-400 mb-6" /></a
			>
