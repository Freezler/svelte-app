...
>
	...
	>
		<button
			class="flex h-[44px] w-[120px] transform items-center active:scale-[0.999]	 justify-center rounded-[12px] bg-blue-900/30 text-center uppercase shadow transition-all duration-300 ease-in-out hover:scale-[1.005] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgba(123,55,255),0.8,rgba(22	,0,255),0.8)] hover:text-white"
			on:click={() => {
		...
		<button
			type="button"
			class="border-[1px] border-bluethree-100 flex h-[44px] w-[120px] transform items-center justify-center rounded-[12px] bg-bluethree-950 text-center uppercase shadow transition-all duration-300 ease-in-out active:schale-[0.999] hover:scale-[1.005] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgb(0,255,255),rgb(0,0,255))] hover:text-white"
			on:click={sendEmail}
		>
			Contact
			<img
				...
				class="text-white hover:animate-smooth duration-[2000ms] focus:animate-wave items-center transition-all"
				alt=""
			/>
		</button>
	</div>
