...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide cubic-bezier-[1.615, 1.31, 1.855, 1] grid h-[100vh] w-[100vw] transform grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden active:scale-100 transition-all  duration-[3000ms] ease-in-out hover:w-[content] "
		>
			<!-- image Container -->
