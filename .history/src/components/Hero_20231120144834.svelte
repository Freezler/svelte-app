...
<button
    ...
    on:click="{() => {
        const icon = document.target.classList;
        target.classList.toggle('spin-animation');
        setTimeout(() => {
...
>
    refresh
    <img src="src/assets/refresh.png" class="img icon h-[16px] w-[16px]  items-center  transition-all" style="opacity: 0.9; filter: invert(0%); margin-left: 5px; height: 16px; width: 16px;" alt="" />
</button>
