...
>
	...
	>
		<button
			class="flex uppercase h-[44px] w-[120px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center shadow duration-300 hover:scale-[1.045] hover:bg-blue-200 active:scale-100 actic"
