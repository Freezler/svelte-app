...
>
	<div class="flex h-[100%] w-[100%] flex-col items-center justify-center  text-center">
		<div>
			<div
				class="px-[40px]  py-10 	md:w-[100%] flex h-[screen] w-full animate-slow-slide-down flex-row-reverse items-center gap-[40px] rounded-[8px] bg-[oklch(12.5%_0.057_322.41)] bg-astral-950 bg-opacity-40 pb-[48px]  text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
			>
				<Avatar
				...
				>
					<span
						class=" mr-[100%] font-handwriting text-[clamp(16px,5vw,6rem)] font-[100] text-redone-100 text-shadow-[3px_3px_5px_rgba(215,252,255,0.9)]"
						>hi, I'm<br />
					</span>RANDY
				</h3>
			</div>
