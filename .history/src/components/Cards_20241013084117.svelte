...
<div class="cards-container">
	...
	<div class="card card-first">
		...
		<p class="card-text">
			With pretty stories for which there's little good evidence star stuff harvesting star
			light circumnavigated invent the universe billions upon billions of brilliant syntheses.
		</p>
		<svg
			class="card-like"
			height="32"
	...
	<div class="card card-second">
		...
		<p class="card-text">
			Descended from astronomers encyclopaedia galactica Sea of Tranquility encyclopaedia
			galactica vanquish the impossible courage of our questions. Great turbulent clouds
			emerged into consciousness inconspicuous motes of rock and gas gathered by gravity.
		</p>
		<svg
			class="card-like"
			height="32"
	...
	<div class="card card-third">
		...
		<p class="card-text">
			Brain is the seed of intelligence from which we spring not a sunrise but a galaxyrise
			consciousness take root and flourish Cambrian explosion. Stirred by starlight billions
			upon billions vanquish the impossible the sky calls to us with pretty stories?
		</p>
		<svg
			class="card-like"
			height="32"
	...
	<div class="card card-fourth">
		...
		<p class="card-text">
			Orion's sword venture take root and flourish inconspicuous motes of rock and gas
			vanquish the impossible muse about. A very small stage in a vast cosmic arena two
			ghostly white figures in coveralls and helmets.
		</p>
		<svg
			class="card-like"
			height="32"
...
<div>
	<p class="caption">
		<a
			href="https://www.ditdot.hr/en/css-subgrid-how-to-build-complex-layouts-in-a-simple-way"
			title="ditdot.hr"
			target="_blank">Visit how-to article on our blog</a
		>
	</p>
</div>
