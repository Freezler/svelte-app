...
<div class="relative top-0 left-0 right-0 bottom-0 flex-row w-[100vw] h-[100vh] flex">
  {#each info as item}
  <div class="slide relative transition-all duration-500 ease-in-out flex-1 flex-col h-[100%]">
	<div class=" relative w-full h-full image transition-transform duration-500 ease-in-out transform hover:scale-125">
	  <img class="w-[100%] h-[100vh] hover:w-screen" src={item.image} alt={item.city} />
	</div>
	<div class="z-100 overlay relative w-[100vw] h-[100vh] flex flex-row hover:bg-rgba(0,0,0,0.5) -translate-y-[100%] bg-transparent opacity-0 transition-opacity duration-500 ease-in hover:opacity-100">
