...
>
	{#if isLoading}
		<div
			class=" img-shadow-[3px_3px_5px_rgba(22,22,22,0.7)] flex h-[100%] max-h-[70%] min-h-[100%] w-[60%] min-w-[80%] max-w-[60%] animate-pulse items-center justify-center rounded-[8px] border-[1px] border-purplethree-400"
		>
	...
	{:else if avatarUrl !== ''}
		...
		><h1 class="text-purpleone-100 text-8xl grid place-items-center h-full">randy</h1></div>
	{/if}
