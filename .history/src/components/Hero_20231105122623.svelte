...
<section class="mb-[10%] pb-[1rem] animate-slow-fade-in  sm:mt-[5%] md:mt-[5%] lg:mt-[5%] xl:mt-[5px] w-full md:w-[50%] mx-auto flex h-full flex-col items-center justify-start bg-slate-400 bg-opacity-30 bg-cover text-center">
