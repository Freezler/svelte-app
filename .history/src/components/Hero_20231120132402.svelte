...
>
	...
	>
		...
		<button
			type="button"
			class="flex h-[38px] w-[86px] transition-all 200ms ease-in-out items-center justify-center rounded-[12px] bg-blue-400 text-center duration-900 hover:scale-105 hover:bg-[linear-gradient(45deg,rgb(0,255,255),rgb(0,0,255))] hover:text-white"
			on:click={sendEmail}
		>
			Contact
		</button>
