	...
	<div class="wrapper">
		...
		<form name="signup">
			...
			<input
				...
				required
			/>
			<div class="justify-baseline m-0 flex w-full flex-row border-2 border-slate-900 p-0">
				<label for="agree"><input type="checkbox" id="agree" name="agree" required /></label
				><small id="agree">I agree to the terms and conditions</small>
			</div>
			<hr />
