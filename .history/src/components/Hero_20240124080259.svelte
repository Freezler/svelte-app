...
<section
	...
	class=" z-100 overflow-none h-full border-teal-700 border-4 w-full animate-slow-fade-in flex-col items-center justify-center overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
	<div class="flex flex-col items-center gap-2">
		...
		>
			...
			<p
				class="ml-8 flex w-[content] animate-slow-slide-in-rtl justify-start
			...
			>
				<span class="typewriter">I'm a junior web developer from Amsterdam, the Netherlands</span>
			</p>
			<div
