...
>
	...
	<div
		class={`absolute top-0 z-50	hidden select-none flex-row  items-center  rounded-b-xl justify-center gap-8 bg--950/40 bg-cover bg-center px-8 py-3 font-display text-xl  uppercase text-blueone-50 md:flex ${
