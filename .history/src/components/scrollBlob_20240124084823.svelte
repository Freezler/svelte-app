...
{#if show}
	<div
		id="container"
		class="relative flex h-[50vh] w-[60%] mx-auto justify-center items-center overflow-hidden transition duration-[600ms] rounded p-[3rem]
		"
	>
		{#each info as item}
			<!-- Slide Container -->
			...
			>
				...
				<div
					class=" image lazy-load flex h-[100vh] w-[100vw] transform flex-col items-center overflow-hidden transition duration-[2400ms] ease-in-out"
				>
					<img
						src={item.image}
						class=" h-[100vh] w-[100vw] transform object-fit object-left-top transition duration-[2400ms]"
						alt=""
						loading="lazy"
					/>
					<!-- Overlay Container -->
