...
>
	{#if isLoading}
		<div
			class=" img-shadow-[3px_3px_5px_rgba(22,22,22,0.7)] flex h-[60%] max-h-[70%] w-[60%] min-w-[80%] max-w-[60%] animate-pulse items-center justify-center rounded-[8px] border-[1px] border-purplethree-400"
		>
