<script>
  ...
  <section class=" -translate-y-[80px] animate-slow-fade-in flex justify-center items-center h-[100%] w-full md:w-[60%] mx-auto  bg-blueone-400 bg-opacity-20 bg-cover bg-repeat text-center">
