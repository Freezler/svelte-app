...
>
	<div class="justify-top flex w-[100vh] flex-col items-center border-b-[1px] bg-black">
		{#if isLoading}
			...
			bg-transparent drop-shadow-[5px_5px_115px_hsla(155,100%,69%,0.8)]"
			>
				<p class="text-xl animate-[pulse_2s_ease_infinite] font-type pt-8 text-purplethree-100 drop-shadow-[2px_2px_12px_hsla(155,100%,159%,0.9)]"><Loader />Loading</p>
			</div>
		{:else if avatarUrl !== ''}
			<div
