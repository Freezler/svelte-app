...
>
	<div class="flex w-[100%] flex-col justify-center items-center h-[500px] md:h-[300px] gap-16 md:gap-40">
		<div
			class=" flex m-auto w-[100vw]  animate-slow-fade-in justify-center items-center  "
		>
			<Avatar
