...
>
	<a href="/" class="align-self-start ml-5 mt-5 mr-auto select-none"
	...
	<button class="lg:hidden mr-8 mt-3 animate-burgersmooth" on:click={toggleNav}>
		<div
	...
	>
		...
		<a href="/color cards" class="text-[#EF7FFF]">Color Cards</a>
...
{#if showNav}
	...
	>
		...
		>
			...
			<a href="/color cards" tabindex="0" class="text-[#EF7FFF]">Color Cards</a>
