...
>
	...
	>
		<p
			...
			text-center align-middle font-display text-[clamp(8px,3vw,1.6rem)] font-[500]font-family: "League Spartan", sans-serif; text-purpleone-100 text-shadow-[3px_3px_5px_rgba(2,3,2,0.8)]"
		>
