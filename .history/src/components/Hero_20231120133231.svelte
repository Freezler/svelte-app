...
>
	...
	<!-- buttons start here!! -->
	<div
		class="z-400 xs:scale-120 mt-4 flex h-[100px] w-[100%] flex-row items-center justify-center gap-4 sm:scale-125 md:scale-110 transition-all"
	>
		<button
		...
		<button
			type="button"
			class="flex h-[38px] w-[86px] transition-all transform ease-in-out items-center justify-center rounded-[12px] bg-blue-400 text-center duration-900 hover:scale-105 hover:bg-[linear-gradient(45deg,rgb(0,255,255),rgb(0,0,255))] hover:text-white"
			on:click={sendEmail}
		>
			Contact
			<img src="https://img.icons8.com/ios/50/000000/forward.png" background="red" alt="">
		</button>
	</div>
</section>
