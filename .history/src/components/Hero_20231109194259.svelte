...
<section class="mx-auto w-[100%] md:w-[100%] filter contrast-400 z-100  sm:-translate-y-[190px] md:-translate-y-[220px]  flex flex-col justify-center items-center text-center h-full">
