...
>
	<div class="flex flex-col items-center gap-2">
		...
		>
			...
			<p
				class="ml-8 flex  animate-slow-slide-in-rtl w-[35ch] justify-center text-center
			bg-opacity-20 font-display text-[clamp(8px,3vw,1.6rem)] font-[500] text-purpleone-100 text-shadow-[3px_3px_5px_rgba(2,3,2,0.8)]"
			>
