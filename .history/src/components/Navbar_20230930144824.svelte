...
<nav
	class="fixed select-none flex items-center bottom-0 justify-between w-full h-16 z-10 text-classic_blue_pallete-primary bg-transparent"
>
	<a href="/" class="align-self-start select-none ml-6 mb-6"
	...
	<button class="lg:hidden mr-6 mb-4 animate-burgersmooth" on:click={toggleNav}>
		<div
			class={`w-9 h-[4.1px] bg-[#dfe2ff] my-2 ${
				showNav
	...
	<div
		class={`font-custom mr-8 hidden gap-8 lg:flex text-semibold font-sans items-center justify-center mt-2 ${
