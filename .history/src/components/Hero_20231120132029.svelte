...
>
	...
	>
		<button
			class="flex h-[38px] w-[86px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center shadow duration-300 hover:scale-[1.055] hover:bg-blue-200"
		>
			refresh
		</button>
