...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide cubic-bezier(0.075, 0.82, 0.165, 1) grid h-[100vh] w-[100vw] grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden transition-all duration-[1400ms]  "
		>
			<!-- image Container -->

			<div class=" image h-[100vh] w-[100vw] transform overflow-hidden hover:w-[120vw]">
				<img
					src={item.image}
					class="infinite cubic-bezier(1.375, 0.482, 0.765, 1) relative h-[100vh] w-[100vw] transition-all duration-[12400ms] hover:scale-[1.5]"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
