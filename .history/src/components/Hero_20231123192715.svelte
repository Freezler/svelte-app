...
<section
class=" z-100 overflow-none flex-col-reverse h-[100svh] w-full justify-around items-center animate-slow-fade-in  overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
<div class="z-400 flex w-[100%]   flex-col justify-center items-center ">
	<Avatar
