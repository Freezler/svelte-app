		...
		{#each info as item}
			...
			>
				...
				>
					<img
						src={item.image}
						class=" cubic-bezier(1.375, 0.482, 0.765, 1) h-[100vh] w-[100%] transform  object-fill lg:object-left md:object-cover object-left-bottom transition duration-[200ms] "
						alt=""
						loading="lazy"
					/>
					<!-- Overlay Container -->
