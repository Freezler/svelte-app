...
<body>
	<div class="wrapper">
		...
		<form name="signup">
			...
			<input type="text" id="name" name="name" required placeholder="Randy de Vries" />
			...
			/>
			<div
				class="align-center m-0 flex flex-row-reverse justify-center border-2 border-slate-900 p-0"
			>
				<label for="agree"
