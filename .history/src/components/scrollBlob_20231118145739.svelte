...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide cubic-bezier(0.075, 0.82, 0.165, 1) flex h-[100vh] w-[100vw] grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden transition-all duration-[1400ms] hover:z-10"
		>
			<!-- image Container -->

			<div class=" image absolute inset-0 h-[100vh] w-[100%] flex flex-col items-center justify-center transform overflow-hidden hover:w-[800px]">
				<img
					src={item.image}
