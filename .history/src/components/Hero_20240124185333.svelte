...
>
	...
	>
		...
		box-border h-[120px] animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(5,0%,9%,0.4)]  bg-[hsla(5,0%,9%,0.3)]"
		>
			<h1 class="animate-slow-slide-in-ltr z-50 flex flex-col items-center justify-center">
				Hi, my name is Randy!
			</h1>
			<p
				class=" m-0 flex w-[content] animate-slow-slide-in-rtl items-center justify-center bg-opacity-20 py-8
