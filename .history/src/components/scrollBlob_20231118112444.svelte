...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide cubic-bezier-[1.615, 1.31, 1.855, 1] grid h-[100vh] w-[100vw] transform grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden active:scale-125 transition-all duration-[3200ms] ease-in-out hover:w-[800%] "
		>
			<!-- image Container -->
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				<img
					src={item.image}
					class="relative h-[100%] w-[100%] object-cover object-center hover:scale-125"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
				...
				>
					...
					>
						...
						<!-- Emblem Container -->
						<div
							class="emblem relative z-50 w-[content] transition-transform items-center justify-center opacity-100 transition-opacity duration-[3200ms] ease-in-out"
						>
