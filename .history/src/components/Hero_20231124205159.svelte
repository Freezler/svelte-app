...
<div class="flex flex-col gap-8 items-center">
	<div class="animate-slow-slide-up z-400 flex w-[auto] flex-col justify-center items-center  ">
		<Avatar
			size="250px"
			initials="RV"
			textColor="white"
	...
	<h1 class="mt-16 text-clamp-1 text-3xl sm:text-5xl md:text-6xl xl:8xl">RANDY DE VRIES</h1>
		...
		>
			<button
				class="z-500 active:scale-[0.999] flex py-[2.5px]  px-[5px] transform select-none items-center justify-center rounded-[8px] border-[1px] border-bluethree-100 bg-bluetwo-950/80 text-center text-[12px] uppercase shadow  hover:scale-[1.015] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgba(0,255,255,0.5),rgba(0,0,5,0.5))] hover:text-white hover:drop-shadow-[0px_0px_2px_hsla(5,10%,9%,0.9)] transition-all hover:200ms ease-in-out "
				on:click={() => {
			...
			<button
				type="button"
				class="z-45 active:schale-[0.999] flex h-[44px] py-[2.5px]  px-[5px] transform select-none items-center justify-center rounded-[8px] border-[1px] border-bluethree-100 bg-bluetwo-950/80 text-center text-[12px] uppercase shadow transition-all duration-300 ease-in-out hover:scale-[1.015] hover:bg-blue-200 hover:bg-[linear-gradient(45deg,rgba(0,255,255,0.5),rgba(0,0,5,0.5))]		 hover:text-white hover:drop-shadow-[0px_0px_2px_hsla(5,10%,9%,0.9)]"
				on:click={sendEmail}
			>
				Contact
				<img
