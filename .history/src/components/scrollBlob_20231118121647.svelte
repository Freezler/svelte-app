...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide relative grid h-[100vh] w-[100vw] transform grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden active:scale-100 transition-all  duration-[2000ms] ease-in-out hover:w-[1500%] "
		>
			<!-- image Container -->
			...
			<div  class=" image h-[100vh] w-[100vw]  transform overflow-hidden">
				...
				>
					...
					>
						...
						<ul
							class="city-info opacity-100 z-100 m-8 flex transform translate-y-[30px] flex-col gap-4  px-2 py-4 font-display transition-all duration-[3000ms] ease-in-out"
						>
