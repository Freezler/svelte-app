...
<nav
	class=" fixed bottom-0 w-screen z-40 flex h-20  select-none items-center justify-between bg-transparent px-0 focus:select-none md:top-0  lg:left-[93%] md:px-4"
>
