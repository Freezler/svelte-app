...
<div class="relative flex-row w-[100vw] h-[100vh] flex">
  ...
  <div class="slide relative transition-all duration-500 ease-in-out flex-1 flex-col h-[100vh]">
	...
	<div class=" overlay relative w-full h-full flex items-center transition-all justify-center bg-rgba(0,0,0,0.5) bg-transparent opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100">
