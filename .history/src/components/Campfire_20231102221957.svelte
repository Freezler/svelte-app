...
>
	...
	{:else if avatarUrl !== ''}
		<div
			class=" gap-0shadow-[2px_2px_12px_[rgba(22,22,22,0.7]] drop-shadow-[2px_2px_12px_hsla(234,100%,59%,0.9)]] avatar-image flex h-[60%] max-h-[70%] min-h-[100%] w-[60%] min-w-[80%] max-w-[60%] flex-col rounded-[8px] border-[1px] border-bluetwo-600 bg-cover bg-center drop-shadow-[2px_2px_12px_hsla(255,100%,59%,0.9)]"
