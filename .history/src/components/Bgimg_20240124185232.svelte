...
>
	<div class="justify-top flex w-[100%] flex-col items-center ">
		...
		{:else if avatarUrl !== ''}
			<div
				class="  drop-shadow-[2px_2px_12px_hsla(154,50%,9%,0.9)]] avatar-image flex h-screen w-screen  flex-col items-center justify-center  bg-cover bg-center text-center "
			>
				<Hero />
				<Header />
			</div>
