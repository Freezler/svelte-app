	...
	>
		<div class="flex h-full items-center">
			<div class=" flex h-full w-screen gap-8">
				<div
					class="absolute flex h-full w-full flex-col items-center justify-center backdrop-blur-[5px] border-2 border-white backdrop-brightness-50 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900 bg-cover bg-center bg-no-repeat"
				>
