...
<section class="mb-[1%] pb-[0rem] animate-slow-fade-in   w-full md:w-[50%] mx-auto flex h-full flex-col items-center justify-around bg-slate-400 bg-opacity-30 bg-cover text-center">
  <div class="flex flex-col gap-2">
	<div class="animate-slow-fade-in flex flex-col items-center justify-start -translate-y-[30%]">
