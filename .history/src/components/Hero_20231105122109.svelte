...
<section class="-translate-y-45% animate-slow-fade-in mt-[0%] sm:mt-[0%] md:mt-[0%] lg:mt-[0%] xl:mt-[0px] w-full md:w-[60%] mx-auto flex h-full flex-col items-center justify-start bg-slate-400 bg-opacity-30 bg-cover text-center">
