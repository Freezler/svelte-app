...
<section class=" animate-slow-fade-in grid  aplace-items-center w-full md:w-[60%] mx-auto  h-full bg-slate-400 bg-opacity-30 bg-contain bg-no-repeat text-center">
