...
<section class="absolute top-[30%] xxs:top-[20%] xs:top-[30%] sm:top-[20%] md:top-[20%] xl:top-[20%] mx-auto w-[100%] md:w-[100%] filter contrast-400 z-100 -translate-y-[190px] sm:-translate-y-[190px] md:-translate-y-[220px]  flex flex-col justify-center items-center text-center h-full">
