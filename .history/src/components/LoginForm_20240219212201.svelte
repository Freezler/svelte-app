...
<body>
	<div class="wrapper">
		...
		<form name="signup">
			...
			<label for="password"
				>Password <small
					>(8, max 16 characters. 1 uppercase, 1 lowercase 1 number)</small
				></label
			>
			<input
				type="password"
				...
				required
			/>
			<div class=" border-2 border-slate-900 p-0">
				<label for="agree"> I agree to the terms and conditions</label><input type="checkbox" id="agree" name="agree" required /> 
