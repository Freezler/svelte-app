<script>
  ...
  <section class="filter  -translate-y-[100px] animate-slow-fade-in flex justify-center items-center h-[calc(100vh-40px)] w-full md:w-[60%] mx-auto  bg-slate-400 bg-opacity-30 bg-cover bg-repeat text-center">
