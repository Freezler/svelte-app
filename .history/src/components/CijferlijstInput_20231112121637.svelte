...
<div class="p-4 min-w-[340px]">
	...
	/>
	<textarea bind:value={fileContent} class="text-white h-[2rem] focus:outline-none resize-none w-[content] min-w-[] bg-transparent border-[1px] select-none border-gray-300 rounded p-2"></textarea>
