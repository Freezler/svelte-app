...
>
	...
	>
		...
		>
			<button
				class="active:scale-[0.999] flex h-[44px] w-[120px] transform select-none items-center justify-center rounded-[12px] border-[1px] border-bluethree-100 bg-bluetwo-950/80 text-center text-[12px] uppercase shadow transition-all duration-300 ease-in-out hover:scale-[1.015] hover:bg-blue-200 active:bg-[linear-gradient(45deg,rgb(0,255,255),rgb(0,0,255))] hover:text-white hover:drop-shadow-[0px_0px_2px_hsla(5,10%,9%,0.9)]"
				on:click={() => {
