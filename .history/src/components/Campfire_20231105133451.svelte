...
<main class="flex justify-start items-center mx-auto  h-[100%] w-screen animate-slow-fade-in flex-col sm:justify-center gap-2 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
  <div class="flex flex-col items-center sm:justify-start justify-center gap-2 w-full">
	{#if isLoading}
	<div class="img-shadow-[3px_3px_5px_rgba(22,22,22,0.7)] flex h-[calc(70vh-80px)] w-[100%] min-w-[100%] max-w-[100%] animate-pulse items-center justify-center rounded-[4px] border-[1px] border-purplethree-400">
	  <p class="animate-pulse text-md text-purpleone-100"><Loader />Loading</p>
	  
	</div>
	{:else if avatarUrl !== ''}
	<div class="animate-slow-fade-inimg-shadow-[2px_2px_12px_[rgba(22,22,22,0.7] text-center drop-shadow-[2px_2px_12px_hsla(234,100%,59%,0.9)]] avatar-image flex h-[calc(70vh-80px)] absolute top-[2rem]  w-[100%] min-w-[100%] max-w-[100%] flex-col rounded-[4px] border-[1px] border-bluetwo-600 bg-cover bg-center drop-shadow-[2px_2px_12px_hsla(255,100%,59%,0.9)]">
