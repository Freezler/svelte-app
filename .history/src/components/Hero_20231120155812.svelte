...
>
	<div class="h-[60%] w-[100%] flex-col">
		...
		<div class="flex h-[100vh] w-[100%] flex-col items-center justify-center">
			...
			>
				<p
					class="px-[10px] type font-Poppins justify-items-evenly w-[max-content] animate-slow-slide-in-rtl
					bg-opacity-20 text-left align-middle text-[clamp(8px,3vw,1.6rem)] font-[500] text-purpleone-100 text-shadow-[3px_3px_5px_rgba(2,3,2,0.8)]"
				>
