<script>
	...
	const reloadAvatar = async () => {
		...
		const response = await fetch('https://images.unsplash.com/photo-1496065187959-7f07b8353c55?q=80&w=2970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
