...
>
	...
	>
		...
		<div
			class="z-80 box-border h-[120px] border=[1px] border-[hsla(178,94%,63%,0.9)] bg-[hsla(178,94%,63%,0.2)] px-8 py-8 pb-32 pt-8 text-center drop-shadow-[2px_2px_12px_hsla(5,0%,19%,0.6)]"	
			
		animate-slow-slide-down flex-row items-center justify-center bg-[hsla(178,94%,63%,0.2)] px-8 py-8 pb-32 pt-8 text-center drop-shadow-[2px_2px_12px_hsla(5,0%,19%,0.6)]"
		>
