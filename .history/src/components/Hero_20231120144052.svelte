	...
	>
		<button
			...
			on:click={() =>
				(document.querySelector('img').src =
					`https://source.unsplash.com/560x560/?javascript`)}
		>
			refresh
			<img
				src="src/assets/refresh.png"
				class="img hover-animation selected:animate-spin-fast h-[16px] w-[16px] items-center transition-all"
		...
		>
			...
			<img
				...
				class="hover-animation icon fly-out duration-[2000ms]active:animate-fast-slide-out items-center transition-all"
				alt=""
			/>
		</button>
	</div>
