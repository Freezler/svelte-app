...
<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
	<button
		on:click={sendEmail}
		class="bg-transparent border-cyan-400 border-2 hover:bg-cyan-400 text-white font-bold py-2 px-4 min-w-[200px] rounded-[16px] transition duration-300 ease-in-out"
		data-te-ripple-init
