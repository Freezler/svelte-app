...
<nav
	class=" m-0 p-0 min-w-[screen] fixed bottom-0 z-40 flex h-full w-screen select-none items-top justify-center bg-transparent px-0 focus:select-none md:top-0"
>
	<a href="/" class="ml-3 flex h-16 select-none md:bg-red-100 focus:select-none items-center justify-center"
		><svg
			class="flex h-20 animate-pulse  md:w-screen"
			version="1.1"
