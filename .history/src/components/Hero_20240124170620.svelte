...
<section
	transition:fade={{ delay: 4, duration: 600 }}
...
>
	<div
		class="flex flex-col items-center gap-8 rounded-md   bg-greyone-900/20 bg-opacity-40 bg-clip-padding p-8 backdrop-blur-[2px] backdrop-filter
	"
	>
		<div
