...
<section class="absolute top-[25%] xxs:top-[35%] xs:top-[40%] sm:top-[45%] md:top-[40%] lg:top-[30%] xl:top-[30%] mx-auto w-[100%] md:w-[100%] filter contrast-400 z-100 -translate-y-[190px] sm:-translate-y-[190px] md:-translate-y-[220px]  flex flex-col justify-center items-center text-center h-full">
	<div class="relative flex flex-col items-center justify-center">
		...
		<div class="font-[500] mt-4 pb-4">
			...
			<button class="text-[clamp(12px,2vw,20px)] text-purple-40 bg-purplethree-200 py-1 px-2 md:py-2 md:px-6 rounded-md hover:text-white hover:bg-purpleone-400 transition-colors duration-300 hover:transition-colors hover:transition-duration-300 ease-in-out" on:click={sendEmail}  type="button">
				CONTACT
			</button>
		</div>
	</div>
