		...
		{#each panels as panel, index}
			...
			>
				<div class="accordion-trigger" aria-expanded={panel === expandedPanel}>
					<div
						class="text-white animate-fast-fade-outaccordion-title relative isolate grid place-items-center rounded-sm bg-gray-200 bg-opacity-30 font-display font-bold"
					>
						{panel.title}
					</div>
				</div>
