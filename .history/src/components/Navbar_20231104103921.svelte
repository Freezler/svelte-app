...
<nav
	class="select-none min-w-[100%] fixed bottom-0 z-40 flex h-20 w-full select-none items-center justify-between bg-transparent px-0 focus:select-none md:top-0"
>
