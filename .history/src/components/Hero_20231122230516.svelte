	...
	<div class="h-[clamp(220px, 20vw, 250px] w-[100%] flex-col">
		...
		<div class="flex flex-col">
			...
			>
				<h3
					class=" 
					font-Poppins animate-slow-slide-down bg-[url(https://source.unsplash.com/1920x1080/?computers)] bg-cover bg-clip-text bg-center bg-no-repeat text-center h-[100]
