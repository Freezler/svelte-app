...
<main class="overflow-hidden flex items-center justify-center mx-auto  h-[100vh] w-screen animate-slow-fade-in flex-col bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900 ">
  <div class="border-b-[1px] border-purpleone-600 flex flex-col items-center justify-top  w-full">
	...
	{:else if avatarUrl !== ''}
	<div class="  z-1000 scale-100 xs:scale-100 sm:scale-100  h-screen text-center drop-shadow-[2px_2px_12px_hsla(234,100%,59%,0.9)]] avatar-image flex items-center justify-center w-[100%] min-w-[100%] max-w-[100%] flex-col bg-cover bg-center drop-shadow-[2px_2px_12px_hsla(255,100%,59%,0.9)]">
			  <Hero />
	</div>
	{/if}
  </div>
