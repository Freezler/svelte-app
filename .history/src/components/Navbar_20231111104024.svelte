...
>
	<a href="/" class="ml-3 flex h-16 select-none items-center justify-start focus:select-none"
		><svg
			class="flex h-20 animate-pulse md:bg-red-200 md:w-screen md:float-left"
			version="1.1"
