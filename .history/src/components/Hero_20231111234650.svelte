...
<section class="mx-auto w-[100%] md:w-[100%] filter contrast-150x	 z-100   flex flex-col justify-center items-center text-center h-full">
	<div class="relative flex flex-col items-center justify-center">
		...
		<div class="font-[900] mt-4 pb-4 ">
			<button class="w-[200px] text-[clamp(12px,2vw,20px)] text-purple-700 bg-purplethree-200 py-1 px-2 md:py-2 md:px-6 rounded-md hover:text-white hover:bg-purpleone-400 transition-colors duration-300 hover:transition-colors hover:transition-duration-300 ease-in-out" type="button">
				INFO
			</button>
