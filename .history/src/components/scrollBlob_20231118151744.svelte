...
>
	{#each info as item}
		...
		>
			...
			<div class=" image h-[100vh] w-[100vw] flex flex-col  transform overflow-hidden hover:w-[2000px]">
				<img
					src={item.image}
					class=" h-[100vh] object-cover object-left-bottom w-[100vw] transition-all duration-[2400ms] hover:scale-125"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
