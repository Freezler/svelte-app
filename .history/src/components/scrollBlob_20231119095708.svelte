		...
		{#each info as item}
			...
			>
				...
				>
					<img
						src={item.image}
						class=" cubic-bezier(1.375, 0.482, 0.765, 1) h-[100vh] w-[100%] transform  object-fill md:object-center md:object-cover object-left-bottom transition duration-[4200ms] "
						alt=""
						loading="lazy"
					/>
					<!-- Overlay Container -->
