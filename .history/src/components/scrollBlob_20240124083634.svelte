...
{#if show}
	...
	>
		{#each info as item}
			<!-- Slide Container -->
			<div
				class="slide flex h-[100vh] w-[100vw]  hover:w-[2200px]  flex-col  items-center justify-center overflow-hidden transition-all duration-[1600ms] cubic-bezier(0.075, 0.82, 0.165, 1)"
			>
				<!-- image Container -->

				<div
					class=" image flex h-[100vh] w-[100vw] transform flex-col items-center  overflow-hidden loading-lazy transition duration-[2400ms] ease-in-out"
				>
					<img
						src={item.image}
						class=" h-[100vh] w-[100vw] transform  object-fill lg:object-left md:object-cover object-left-bottom transition duration-[2400ms] "
						alt=""
						loading="lazy" 
					/>
					<!-- Overlay Container -->
					...
					>
						<!-- Content Container -->
						<div
							class="b-4 content z-100 flex flex-1 transform flex-col items-center justify-center text-center font-display text-white  shadow-2xl box-shadow-2xl transition duration-[1900ms] ease-in-out text-shadow-[3px_3px_5px_hsla(230,45%,10%,0.9)] "
						>
							<h1
								class="title font-mono text-[clamp(1.2rem,5vw,4rem)] font-[900] text-white opacity-1 
							"
							...
							<ul
								class="city-info opacity-1 z-100 flex  flex-col  font-mono  "
							>
...
<style>
	* {
	...
	.content {
    transition: transform 600ms cubic-bezier(0.445, 0.05, 0.55, 0.95), width 600ms cubic-bezier(0.445, 0.05, 0.55, 0.95), opacity 900ms cubic-bezier(0.445, 0.05, 0.55, 0.95);
...
.emblem {
    ...
    height: 100vh;
    width: 100vw;
    transition: object-fit 2400ms cubic-bezier(0.455, 0.03, 0.515, 0.955), object-position 2400ms cubic-bezier(0.455, 0.03, 0.515, 0.955), height 2400ms cubic-bezier(0.455, 0.03, 0.515, 0.955), width 2400ms cubic-bezier(0.455, 0.03, 0.515, 0.955);
}
