...
>
	<div class="flex flex-col items-center gap-8">
		...
		<div
			class=" z-100 mx-auto h-[120px] w-[100%] animate-slow-slide-down flex-row items-center justify-center text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.8)]"
		>
			<h1 class="z-50 flex w-[65ch] animate-slow-slide-in-ltr items-center justify-center flex-col">
				RANDY DE VRIES | WEB DEVELOPER | SVELTE
			</h1>
			<p
				class="flex w-[100%] animate-slow-slide-in-rtl items-center justify-center bg-opacity-20
			text-center font-display text-[clamp(8px,2vw,1rem)] font-[500] text-purpleone-100 text-shadow-[3px_3px_5px_rgba(2,3,2,0.8)]"
			>
				<span class="typewriter"
					>I'm a junior web developer from Amsterdam, the Netherlands</span
				>
			</p>
			<div
...
<style>
	span.typewriter {
		...
		letter-spacing: 1.6; /* Adjust as needed */
		color: aliceblue;
		animation:
