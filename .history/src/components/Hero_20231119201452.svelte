...
>
	<div class="-space-y-0 flex h-[100%] w-[100%] flex-col items-center justify-center gap-12 text-center">
		<div>
			<div
				class="animate-slow-slide-down gap-[40px] flex h-[screen] w-[100vw] flex-row-reverse place-content-center items-center justify-items-center rounded-[8px] bg-[oklch(12.5%_0.057_322.41)] bg-astral-950 bg-opacity-40 px-6 pb-[40px] pt-4 text-center drop-shadow-[2px_2px_12px_hsla(245,20%,35%,0.3)]"
			>	
		<Avatar
		...
		/>
			<h3 class="font-display text-[clamp(10px,10vw,8rem)] font-[900] text-blueone-200 text-shadow-[3px_3px_5px_rgba(222,22,2,0.4)] ">
				<span class="font-serif text-[clamp(16px,5vw,6rem)] font-[100] text-shadow-[3px_3px_5px_rgba(242,12,55,0.4)] text-redone-100"
					>hi, I'm<br />
				</span>RANDY
			</h3>
		</div>
