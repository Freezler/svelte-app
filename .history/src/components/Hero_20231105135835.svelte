...
<section class="mb-[1%] pb-[0rem] animate-slow-fade-in   w-full md:w-[50%] mx-auto flex h-[100%


] flex-col items-center justify-around bg-slate-400 bg-opacity-30 bg-cover text-center">
