...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide relative grid h-[100%] w-[100%]  grid-cols-1 grid-rows-1 place-content-center justify-items-middle overflow-hidden active:scale-125 transition-all  duration-[1900ms] ease-in-out cubic-bezier(0.075, 0.82, 0.165, 1) hover:w-[1500%] "
		>
			<!-- image Container -->
