...
>
	...
	<p class="text-purpleone-100 text-2xl grid place-items-center h-full w-[100%] text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente quaerat dolore rem obcaecati omnis deserunt.</p></div>
	{/if}
