...
<section
	class="z-100 overflow-none -translate-y-10 bg-[oklch(12.5%_0.057_322.41)]bg-opacity-40 flex h-[100svh] w-screen animate-slow-fade-in flex-co
l items-center justify-center overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
