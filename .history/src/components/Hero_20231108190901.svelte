<script>
  ...
  <section class="animate-slow-fade-in flex justify-center items-center h-[440px] w-full md:w-[60%] mx-auto  bg-slate-400 bg-opacity-30 bg-cover bg-repeat text-center">
	<div class="flex flex-col relative ">
	  <div class="translate-y-[-60%] animate-slow-fade-in flex flex-col items-center justify-center">
		<Avatar bgColor="goldenrodyellow" textColor="white" name="Randy de vries" src="https://avataaars.io/?ajvatarStyle=Circle&topType=NoHair&accessoriesType=Blank&facialHairType=Blank&clotheType=Hoodie&clotheColor=Blue03&eyeType=Default&eyebrowType=RaisedExcitedNatural&mouthType=Twinkle&skinColor=Pale" size="calc(32vh - 40px)" />
	  </div>
