...
>
	...
	>
		...
		animate-slow-slide-down flex-row rounded-lg items-center justify-center bg-[hsla(178,94%,63%,0.2)] px-8 py-8 pb-32 pt-8 text-center drop-shadow-[2px_2px_12px_hsla(5,50%,59%,0.5)]"
		>
