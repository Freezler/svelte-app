		...
		>
			...
			<div class=" image h-[100vh] w-[100vw] flex flex-col items-center justify-center transform overflow-hidden">
				...
				<div class="overlay absolute inset-0 transform flex h-[100%] w-[100%] items-center justify-center">
					<!-- Content Container -->
					<div
						class="content duration-[400ms] z-100 flex flex-1 transform flex-col items-center justify-start text-left font-display text-white opacity-0 shadow-2xl transition-all ease-in-out text-shadow-[3px_3px_5px_hsla(180,45%,4%,0.9)]"
					>
						<h1
