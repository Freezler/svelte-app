	...
	>
		...
		>
			...
			<img
				...
				class="hover:animate-fast-slide-in img icon h-[16px] w-[16px] items-center transition-all"
		...
		>
			...
			<img
				...
				class="fly-out duration-[2000ms]active:animate-fast-slide-out items-center transition-all"
				alt=""
			/>
		</button>
	</div>
