...
>
	...
	<!-- buttons start here!! -->
	<div class="z-400 mx-auto flex  flex-row w-[content] items-center justify-center">
		<button class="h-[30px] w-[180px] rounded-[12px] text-center bg-blue-400  duration-300 hover:bg-blue-200">
			refresh
		</button>

		<button type="button" class="h-[30px] w-[80px] rounded-[8px] bg-blue-400 " on:click={sendEmail} >
			Contact
		</button>
	</div>
</section>
