...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide relative grid h-[100%] w-[100%]  grid-cols-1 grid-rows-1 place-content-center justify-items-end overflow-hidden active:scale-100 transition-all  duration-[2000ms] ease-in-out hover:w-[1500%] "
		>
			<!-- image Container -->
