	...
	{#each info as item}
		...
		>
			...
			<div class=" image h-[100vh] w-[100vw] flex flex-col items-center justify-center transform overflow-hidden">
				<img
					src={item.image}
					class=" h-[100vh] w-[100vw] hover:w-[scale-110] object-cover transition duration-[1400ms] cubic-bezier(1.375, 0.482, 0.765, 1)"
					alt=""
					loading="lazy"
				/>
				<!-- Overlay Container -->
				<div class="overlay absolute inset-0 transform flex h-[100%] w-[100%] items-center justify-center">
					...
					>
						<h1
							class="title border-b-[1px] border-blueone-100 font-sans text-[clamp(1.5rem,5vw,5rem)] font-[900] text-white"
