...
<div class="flex flex-col items-center justify-center">
	<div class="z-400 flex w-[100%] flex-col  m-4 Avatar border-2 radius-full">
		<Avatar
			size="150"
			initials="RV"
			textColor="white"
			name="Randy de vries"
			src="https://source.unsplash.com/300x300/?candy
	"
			alt="Randy de vries"
		/>
	</div>
	<div
		class=" z-100 h-[300px]	 w-[100vw] animate-slow-slide-down flex-col items-center justify-center bg-astral-950 bg-opacity-50 text-center drop-shadow-[2px_2px_12px_hsla(15,00%,59%,0.2)]"
	>
		<p
	...
	* {
	...
	@media screen and (min-width:400px) {
		div.Avatar {
			...
			width: 350px;
			height: 350px;
			background: linear-gradient(45deg, rgb(123, 0, 255), rgb(255, 0, 212), #00f, #0ff, #f0f, rgb(119, 0, 255));
		}
	}
	.type {
		display: inline-flex;
