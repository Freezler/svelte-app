...
>
	<div class="h-[60%] w-[100%] flex-col">
		...
		<div class="flex h-[100vh] w-[100%] flex-col items-center justify-center">
			...
			<!-- buttons start here!! -->
			<div class="z-400 flex  flex-row items-center justify-center space-x-4 text-center">
				<button
				...
				<button class="bg-blue-400 w-[80px] py-8 px-3" role="sumbmit" on:click={() => sendEmail()}
