...
>
	...
	>
		...
		<button
			type="button"
			class="duration-900 flex h-[38px] w-[86px] transform items-center justify-center rounded-[12px] bg-blue-400 text-center transition-all ease-in-out hover:scale-105 hover:bg-[gradient-color: linear-gradient(45deg, rgb(0, 255, 255), rgb(0, 0, 255))] hover:text-white"
			on:click={sendEmail}
			on:keydown={sendEmail}
		>
			Contact
		</button>
	</div>
