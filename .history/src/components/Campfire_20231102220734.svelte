...
<main class="mt-[10%] grid grid-cols-1 place-items-center justify-center min-h-screen  h-screen w-screen animate-slow-fade-in flex-col  gap-4 bg-gradient-to-tr from-astral-900 via-gray-900 to-astral-900">
	{#if isLoading}
	<div class=" border-purplethree-400 min-w-[80%] w-[60%] max-w-[60%] min-h-[60%] h-[80%] img-shadow-[3px_3px_5px_rgba(22,22,22,0.7)]	max-h-[70%] animate-pulse border-2 rounded-[8px] flex items-center justify-start">
