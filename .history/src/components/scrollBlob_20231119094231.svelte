...
{#if show}
	...
	>
		{#each info as item}
			<!-- Slide Container -->
			<div
				class="slide flex h-[100vh] w-[100vw] hover:w-[3300px]  flex-col  items-center justify-center overflow-hidden transition-a duration-[1700ms] cubic-bezier(0.075, 0.82, 0.165, 1)"
			>
				<!-- image Container -->
