...
>
	...
	<div
		class={`absolute top-0 z-50	hidden select-none flex-row  items-center  roundejustify-center gap-8 bg-astral-950/70 bg-cover bg-center px-5 py-5 font-display text-xl  uppercase text-blueone-50 md:flex ${
