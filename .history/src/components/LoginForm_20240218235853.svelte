	...
	<div class="wrapper">
		...
		<form name="signup">
			...
			<input
				...
				required
			/>
			<div class="flex m-0  border-2 border-slate-900 p-0 h-8 align-center justify-center">
				<label for="agree"><input type="checkbox" id="agree" name="agree" required /><small id="agree">I agree to the terms and conditions</small></label
          >
			</div>
			<hr />
