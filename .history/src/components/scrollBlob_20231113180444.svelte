<script>
  ...
  .slide:hover .emblem {
    transform: translateX(100px0);
  }

  </style>
  
  <div id="container relative flex flex-col flex-1 w-[100vw] h-[100vh] items-center ">
  {#each info as item}
  <div class="slide transition-all relative flex-1 h-[100%] w-[100%] overflow-hidden">
	<div class="image transition-transform ease-in-out du " style="background-image: url({item.image});"></div>
