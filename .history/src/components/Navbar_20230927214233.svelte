...
<button class="lg:hidden mr-7 animate-burger-smooth" on:click={toggleNav}>
	<div
		class="w-7 h-1 bg-[#EF7FFF] transition-all duration-300 transform origin-center ${showNav
			? 'rotate-45 translate-y-1'
			: ''}"
	/>
	<div
		class="w-7 h-1 bg-[#EF7FFF] transition-opacity duration-300 ${showNav
...
>
	<a href="/" class="align-self-start ml-4 mt-3xz mr-auto select-none"
