...
>
	{#each info as item}
		<!-- Slide Container -->
		<div
			class="slide cubic-bezier-[1.615, 1.31, 1.855, 1] grid h-[100vh] w-[100vw] transform grid-cols-1 grid-rows-1 place-content-center justify-items-center overflow-hidden ascale-125 transition duration-[600ms] ease-in-out hover:w-[800%] "
		>
			<!-- image Container -->
