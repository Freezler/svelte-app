...
<section
	class=" z-100 overflow-none flex-col h-[100svh]justify-center items-center w-screen animate-slow-fade-in  overflow-hidden text-center drop-shadow-[2px_2px_12px_hsla(245,90%,5%,0.3)]"
>
	<div class="flex w-[100%] md:flex-row-reverse flex-col justify-center items-center h-[500px] md:h-[390px] gap-4 md:gap-4"><Avatar
		size="clamp(120px, 20vh, 150px)"
		initials="RV"
		textColor="white"
		name="Randy de vries"
