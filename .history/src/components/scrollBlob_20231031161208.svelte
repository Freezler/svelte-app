<div class="relative">
	<div class="relative z-50 animate-slow-fade-in text-center">
		<h1
			class="drop-shadow-[3px 3px 3px rgba(22, 22, 22, 0.9)] translate-y-52 text-center font-display text-6xl font-bold bg-[url(https://cdn.discordapp.com/emojis/965692558526640640.png?v=1)] bg-clip-text bg-no-repeat filter"
		>
			Jack o'Lantern
		</h1>
	</div>
