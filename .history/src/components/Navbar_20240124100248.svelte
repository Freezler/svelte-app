...
<nav
	class=" fixed bottom-0 left-0 right-0 z-10 flex w-[100%] select-none items-center justify-between text-center antialiased md:bottom-auto md:right-0 md:top-4 md:justify-center md:absolute"
>
	<svg
