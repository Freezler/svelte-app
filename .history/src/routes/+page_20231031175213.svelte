				...
				<div
					...
					<p
						class="pb-[2rem] mx-4 line-clamp-3 w-full items-center justify-center text-center font-sans text-[clamp(0.75rem,2vw,1.5rem)] font-thin text-white">
						 Welkom op mijn privépagina waar ik mijn persoonlijke progressie deel. Hier kan ik mijn kennis bijhouden en mijn "skills" . Dit is mijn eigen ruimte om mijn prestaties te volgen en te reflecteren. Voel je vrij om mee te kijken en mij aan te moedigen op mijn reis naar succes.
					</p>
					<HeroButton />
				</div>
			</div>
