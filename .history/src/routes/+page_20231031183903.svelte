		...
		<div class="flex h-screen items-center justify-center">
			<div class="mx-auto flex h-full w-full flex-col">
				...
				<div
					...
					<p
						class="line-height-3 mx-4 h-[100%] max-h-[1000px] md:180px lg:200px xl:h-[200px] w-[80%] items-center justify-center text-center font-sans text-[clamp(0.70rem,2vw,1.5rem)] font-thin text-white">
