	...
	<div
		...
		<div class="flex h-screen items-center justify-center">
			<div class="mx-auto flex h-full w-full flex-col">
				<h1
					class="text-shadow-[3px_3px_5px_[rgba(22,22,22,0.7]] animate-slow-fade-in text-skew-y-1 drop-shadow-[3px_3px_5px_rgba(22,22,22,0.7)]md:transform-none mb-[5%] mt-[4%] w-[100%] transform  -space-x-3 text-center font-handwriting text-[clamp(4rem,12vw,10rem)] font-[800]">
					{#each `RANDY` as char}
						<span
				...
				<div
					class=" box-shadow-[4px_4px_5px_rgba(2,12,34,0.3)] mx-auto flex w-[90%] min-w-[80%] max-w-[50%] items-center justify-center rounded border-[1px] border-bluethree-900 bg-greytwo-100/10 bg-cover bg-center bg-no-repeat px-5 py-16 text-center backdrop-blur-xl">
					<p
						class=" mx-4 line-clamp-4 w-full items-center justify-center text-center font-sans text-[clamp(0.70rem,2vw,1.5rem)] font-thin text-white">
