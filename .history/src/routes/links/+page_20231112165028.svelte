...
<main
	class=" z-100 grid grid-cols-1 h-screen scroll-smooth place-content-center justify-center items-center w-screen flex-col bg-gradient-to-b from-astral-900 via-gray-900 to-astral-900 overflow-scroll pb-24"
>	
<div class="grid grid-cols-1 place-content-centerx	text-center w-[100%] items-center justify-center font-sans h-screen ">
