...
<main
	class="animate-slow-fade-in z-100 grid grid-cols-1 h-screen scroll-smooth place-content-start justify-center items-center w-screen flex-col bg-gradient-to-b overflow-scroll pb-24" 
>	
