...
<main
	class=" z-100 grid grid h-screen scroll-smooth justify-center items-center w-screen flex-col bg-gradient-to-b from-astral-900 via-gray-900 to-astral-900 overflow-scroll pb-24"
>	
